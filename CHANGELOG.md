...
*As of this notice, using CHANGELOG.md is DEPRECATED. We will be using [GitHub Releases](https://github.com/pulumi/pulumi-spotinst/releases) for this repository*
...
## 3.12.1 (2021-12-20)
* Upgrade to v1.64.1 of the SpotInst Terraform Provider
