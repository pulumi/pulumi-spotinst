...
@CustomType
public final class OceanAutoscalerHeadroom {
    ...
    public static Builder builder(OceanAutoscalerHeadroom defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer numOfUnits;
        public Builder() {}
        public Builder(OceanAutoscalerHeadroom defaults) {
        ...
        public OceanAutoscalerHeadroom build() {
            final var _resultValue = new OceanAutoscalerHeadroom();
