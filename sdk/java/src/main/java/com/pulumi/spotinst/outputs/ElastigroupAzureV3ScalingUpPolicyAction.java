...
@CustomType
public final class ElastigroupAzureV3ScalingUpPolicyAction {
    ...
    public static Builder builder(ElastigroupAzureV3ScalingUpPolicyAction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(ElastigroupAzureV3ScalingUpPolicyAction defaults) {
        ...
        public ElastigroupAzureV3ScalingUpPolicyAction build() {
            final var _resultValue = new ElastigroupAzureV3ScalingUpPolicyAction();
