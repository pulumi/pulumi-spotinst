...
public final class ElastigroupIntegrationEcsAutoscaleAttributeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ElastigroupIntegrationEcsAutoscaleAttributeArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("ElastigroupIntegrationEcsAutoscaleAttributeArgs", "key");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("ElastigroupIntegrationEcsAutoscaleAttributeArgs", "value");
            }
            return $;
        }
    }
