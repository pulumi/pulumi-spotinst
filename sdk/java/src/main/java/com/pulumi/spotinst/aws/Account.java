...
import com.pulumi.spotinst.aws.inputs.AccountState;
 ...
 * 
 */
@ResourceType(type="spotinst:aws/account:Account")
public class Account extends com.pulumi.resources.CustomResource {
    ...
    public Account(java.lang.String name, @Nullable AccountArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("spotinst:aws/account:Account", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Account(java.lang.String name, Output<java.lang.String> id, @Nullable AccountState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("spotinst:aws/account:Account", name, state, makeResourceOptions(options, id), false);
    }
