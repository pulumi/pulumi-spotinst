...
@CustomType
public final class OceanImportShieldedInstanceConfig {
    /**
    ...
    private OceanImportShieldedInstanceConfig() {}
    /**
     * @return Boolean. Enable the integrity monitoring parameter on the GCP instances.
     * 
     */
    ...
    public static Builder builder(OceanImportShieldedInstanceConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean enableSecureBoot;
        public Builder() {}
        public Builder(OceanImportShieldedInstanceConfig defaults) {
