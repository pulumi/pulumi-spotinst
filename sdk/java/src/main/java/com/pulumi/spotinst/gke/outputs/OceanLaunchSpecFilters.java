...
@CustomType
public final class OceanLaunchSpecFilters {
    /**
    ...
    private OceanLaunchSpecFilters() {}
    /**
     * @return Types belonging to a family from the ExcludeFamilies will not be available for scaling (asterisk wildcard is also supported). For example, C* will exclude instance types from these families: c5, c4, c4a, etc.
     * 
     */
    ...
    public static Builder builder(OceanLaunchSpecFilters defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer minVcpu;
        public Builder() {}
        public Builder(OceanLaunchSpecFilters defaults) {
        ...
        public OceanLaunchSpecFilters build() {
            final var _resultValue = new OceanLaunchSpecFilters();
