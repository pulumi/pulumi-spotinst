...
public final class ElastigroupAzureV3ScalingUpPolicyActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final ElastigroupAzureV3ScalingUpPolicyActionArgs Empty = new ElastigroupAzureV3ScalingUpPolicyActionArgs();
    ...
    private ElastigroupAzureV3ScalingUpPolicyActionArgs() {}

    private ElastigroupAzureV3ScalingUpPolicyActionArgs(ElastigroupAzureV3ScalingUpPolicyActionArgs $) {
    ...
    public static Builder builder(ElastigroupAzureV3ScalingUpPolicyActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ElastigroupAzureV3ScalingUpPolicyActionArgs();
        }

        public Builder(ElastigroupAzureV3ScalingUpPolicyActionArgs defaults) {
            $ = new ElastigroupAzureV3ScalingUpPolicyActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ElastigroupAzureV3ScalingUpPolicyActionArgs build() {
            return $;
        }
    }
