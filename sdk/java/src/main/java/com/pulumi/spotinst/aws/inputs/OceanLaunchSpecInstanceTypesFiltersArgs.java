...
public final class OceanLaunchSpecInstanceTypesFiltersArgs extends com.pulumi.resources.ResourceArgs {

    public static final OceanLaunchSpecInstanceTypesFiltersArgs Empty = new OceanLaunchSpecInstanceTypesFiltersArgs();
    ...
    private OceanLaunchSpecInstanceTypesFiltersArgs() {}

    private OceanLaunchSpecInstanceTypesFiltersArgs(OceanLaunchSpecInstanceTypesFiltersArgs $) {
    ...
    public static Builder builder(OceanLaunchSpecInstanceTypesFiltersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OceanLaunchSpecInstanceTypesFiltersArgs();
        }

        public Builder(OceanLaunchSpecInstanceTypesFiltersArgs defaults) {
            $ = new OceanLaunchSpecInstanceTypesFiltersArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param categories The filtered instance types will belong to one of the categories types from this list. Valid values: `Accelerated_computing`, `Compute_optimized`, `General_purpose`, `Memory_optimized`, `Storage_optimized`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param diskTypes The filtered instance types will have one of the disk type from this list. Valid values: `NVMe`, `EBS`, `SSD`, `HDD`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param hypervisors The filtered instance types will have a hypervisor type from this list. Valid values: `nitro`, `xen`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param rootDeviceTypes The filtered instance types will have a root device types from this list. Valid values: `ebs`, or `instance-store`.
         * 
         * @return builder
         * 
         */
        ...
        public OceanLaunchSpecInstanceTypesFiltersArgs build() {
            return $;
        }
    }
