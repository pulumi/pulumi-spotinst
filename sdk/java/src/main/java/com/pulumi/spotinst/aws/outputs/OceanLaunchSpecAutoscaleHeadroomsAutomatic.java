...
public final class OceanLaunchSpecAutoscaleHeadroomsAutomatic {
    /**
     * @return Number between 0-200 to control the headroom % of the specific Virtual Node Group. Effective when cluster.autoScaler.headroom.automatic.`isEnabled` = true is set on the Ocean cluster.
     * 
     */
