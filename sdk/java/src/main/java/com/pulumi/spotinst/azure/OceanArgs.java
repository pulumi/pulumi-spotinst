...
public final class OceanArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="acdIdentifier", required=true)
     ...
     * 
     */
    @Import(name="aksName", required=true)
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder acdIdentifier(Output<String> acdIdentifier) {
         ...
         * 
         */
        public Builder aksName(Output<String> aksName) {
            $.aksName = aksName;
            return this;
        }
