...
import com.pulumi.spotinst.multai.DeploymentArgs;
import com.pulumi.spotinst.multai.inputs.DeploymentState;
import java.lang.String;
import javax.annotation.Nullable;

@ResourceType(type="spotinst:multai/deployment:Deployment")
public class Deployment extends com.pulumi.resources.CustomResource {
    ...
    private Deployment(String name, Output<String> id, @Nullable DeploymentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("spotinst:multai/deployment:Deployment", name, state, makeResourceOptions(options, id));
    }
