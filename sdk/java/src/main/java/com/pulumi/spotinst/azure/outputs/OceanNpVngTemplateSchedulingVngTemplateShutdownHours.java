...
public final class OceanNpVngTemplateSchedulingVngTemplateShutdownHours {
    ...
    public static Builder builder(OceanNpVngTemplateSchedulingVngTemplateShutdownHours defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> timeWindows;
        public Builder() {}
        public Builder(OceanNpVngTemplateSchedulingVngTemplateShutdownHours defaults) {
        ...
        public OceanNpVngTemplateSchedulingVngTemplateShutdownHours build() {
            final var _resultValue = new OceanNpVngTemplateSchedulingVngTemplateShutdownHours();
