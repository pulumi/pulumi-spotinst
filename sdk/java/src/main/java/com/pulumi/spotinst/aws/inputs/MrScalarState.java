...
public final class MrScalarState extends com.pulumi.resources.ResourceArgs {

    public static final MrScalarState Empty = new MrScalarState();
    ...
    @Import(name="outputClusterId")
    private @Nullable Output<String> outputClusterId;

    public Optional<Output<String>> outputClusterId() {
        return Optional.ofNullable(this.outputClusterId);
    }
    ...
    private MrScalarState() {}

    private MrScalarState(MrScalarState $) {
        ...
        this.name = $.name;
        this.outputClusterId = $.outputClusterId;
    ...
    public static Builder builder(MrScalarState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(MrScalarState defaults) {
            $ = new MrScalarState(Objects.requireNonNull(defaults));
        }
        ...
        public Builder outputClusterId(@Nullable Output<String> outputClusterId) {
            $.outputClusterId = outputClusterId;
            return this;
        }

        public Builder outputClusterId(String outputClusterId) {
            return outputClusterId(Output.of(outputClusterId));
        }
