...
public class VerificationTemplate extends com.pulumi.resources.CustomResource {
     ...
     */
    public VerificationTemplate(java.lang.String name) {
     ...
     */
    public VerificationTemplate(java.lang.String name, @Nullable VerificationTemplateArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VerificationTemplate(java.lang.String name, @Nullable VerificationTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("spotinst:oceancd/verificationTemplate:VerificationTemplate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VerificationTemplate(java.lang.String name, Output<java.lang.String> id, @Nullable VerificationTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("spotinst:oceancd/verificationTemplate:VerificationTemplate", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static VerificationTemplate get(java.lang.String name, Output<java.lang.String> id, @Nullable VerificationTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
