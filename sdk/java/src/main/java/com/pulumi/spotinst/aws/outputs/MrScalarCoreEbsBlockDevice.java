...
public final class MrScalarCoreEbsBlockDevice {
    ...
    public static final class Builder {
        ...
        public Builder sizeInGb(Integer sizeInGb) {
            if (sizeInGb == null) {
              throw new MissingRequiredPropertyException("MrScalarCoreEbsBlockDevice", "sizeInGb");
            }
        ...
        public Builder volumeType(String volumeType) {
            if (volumeType == null) {
              throw new MissingRequiredPropertyException("MrScalarCoreEbsBlockDevice", "volumeType");
            }
