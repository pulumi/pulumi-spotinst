...
public final class OceanImportState extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="clusterControllerId")
    private @Nullable Output<String> clusterControllerId;

    public Optional<Output<String>> clusterControllerId() {
        return Optional.ofNullable(this.clusterControllerId);
    }
    ...
    public static Builder builder(OceanImportState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder clusterControllerId(@Nullable Output<String> clusterControllerId) {
            $.clusterControllerId = clusterControllerId;
            return this;
        }

        public Builder clusterControllerId(String clusterControllerId) {
            return clusterControllerId(Output.of(clusterControllerId));
        }
