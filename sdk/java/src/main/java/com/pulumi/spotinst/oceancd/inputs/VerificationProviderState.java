...
public final class VerificationProviderState extends com.pulumi.resources.ResourceArgs {

    public static final VerificationProviderState Empty = new VerificationProviderState();
    ...
    private VerificationProviderState(VerificationProviderState $) {
    ...
    public static Builder builder(VerificationProviderState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VerificationProviderState();
        }

        public Builder(VerificationProviderState defaults) {
            $ = new VerificationProviderState(Objects.requireNonNull(defaults));
        }
        ...
        public VerificationProviderState build() {
            return $;
        }
    }
