...
public final class OceanLaunchSpecAutoscaleHeadroomsAutomaticArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param autoHeadroomPercentage Number between 0-200 to control the headroom % of the specific Virtual Node Group. Effective when cluster.autoScaler.headroom.automatic.`isEnabled` = true is set on the Ocean cluster.
         * 
         * @return builder
         * 
         */
