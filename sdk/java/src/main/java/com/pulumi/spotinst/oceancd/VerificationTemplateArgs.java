...
public final class VerificationTemplateArgs extends com.pulumi.resources.ResourceArgs {

    public static final VerificationTemplateArgs Empty = new VerificationTemplateArgs();
    ...
    public static Builder builder(VerificationTemplateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VerificationTemplateArgs();
        }

        public Builder(VerificationTemplateArgs defaults) {
            $ = new VerificationTemplateArgs(Objects.requireNonNull(defaults));
        }
