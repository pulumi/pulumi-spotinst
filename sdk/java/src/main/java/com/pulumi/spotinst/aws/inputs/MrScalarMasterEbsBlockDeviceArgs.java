...
public final class MrScalarMasterEbsBlockDeviceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public MrScalarMasterEbsBlockDeviceArgs build() {
            if ($.sizeInGb == null) {
                throw new MissingRequiredPropertyException("MrScalarMasterEbsBlockDeviceArgs", "sizeInGb");
            }
            if ($.volumeType == null) {
                throw new MissingRequiredPropertyException("MrScalarMasterEbsBlockDeviceArgs", "volumeType");
            }
            return $;
        }
    }
