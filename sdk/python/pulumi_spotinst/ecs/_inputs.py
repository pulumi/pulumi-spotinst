...
class OceanAutoscalerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[int] auto_headroom_percentage: The auto-headroom percentage. Set a number between 0-200 to control the headroom %!o(MISSING)f the cluster. Relevant when `isAutoConfig`= true.
...
class OceanAutoscalerDownArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[float] max_scale_down_percentage: Would represent the maximum %!t(MISSING)o scale-down. Number between 1-100.
        """
...
class OceanUpdatePolicyRollConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] batch_min_healthy_percentage: Default: 50. Indicates the threshold of minimum healthy instances in single batch. If the amount of healthy instances in single batch is under the threshold, the cluster roll will fail. If exists, the parameter value will be in range of 1-100. In case of null as value, the default value in the backend will be 50%! (MISSING)Value of param should represent the number in percentage (%!)(MISSING) of the batch.
