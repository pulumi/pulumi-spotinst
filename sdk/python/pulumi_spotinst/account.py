...
class AccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Provide a name for your account. The account name must contain at least one character that is a-z or A-Z.
        """
        if name is not None:
...
class Account(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Account, __self__).__init__(
            'spotinst:index/account:Account',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'Account':
        """
