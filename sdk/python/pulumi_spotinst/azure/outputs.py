...
class ElastigroupHealthCheck(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str health_check_type: Health check used to validate VM health. Valid values: “INSTANCE_STATE”.
        :param bool auto_healing: Enable auto-healing of unhealthy VMs.
        :param int grace_period: Period of time (seconds) to wait for VM to reach healthiness before monitoring for unhealthiness.
        """
...
class ElastigroupScalingDownPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str adjustment: Value to which the action type will be adjusted. Required if using `numeric` or `percentage_adjustment` action types.
...
class ElastigroupScheduledTask(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str batch_size_percentage: The percentage size of each batch in the scheduled deployment roll. Required when the 'task_type' is 'roll'.
        :param str grace_period: Period of time (seconds) to wait for VM to reach healthiness before monitoring for unhealthiness.
...
class ElastigroupUpdatePolicyRollConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param int batch_size_percentage: The percentage size of each batch in the scheduled deployment roll. Required when the 'task_type' is 'roll'.
        :param int grace_period: Period of time (seconds) to wait for VM to reach healthiness before monitoring for unhealthiness.
        :param str health_check_type: Health check used to validate VM health. Valid values: “INSTANCE_STATE”.
        """
        pulumi.set(__self__, "batch_size_percentage", batch_size_percentage)
