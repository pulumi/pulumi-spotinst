...
class OceanExtendedResourceDefinitionArgs:
    def __init__(__self__, *,
                 resource_mapping: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a OceanExtendedResourceDefinition resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] resource_mapping: A mapping between AWS instanceType or * as default and its value for the given extended resource.
        :param pulumi.Input[builtins.str] name: The extended resource name as should be requested by your pods and registered to the nodes. Cannot be updated.
    ...
    def resource_mapping(self) -> pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]:
        """
    ...
    def resource_mapping(self, value: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
...
class _OceanExtendedResourceDefinitionState:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 resource_mapping: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
    ...
    @property
    @pulumi.getter(name="resourceMapping")
    def resource_mapping(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        A mapping between AWS instanceType or * as default and its value for the given extended resource.
        """
        return pulumi.get(self, "resource_mapping")
    ...
    @resource_mapping.setter
    def resource_mapping(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "resource_mapping", value)
...
class OceanExtendedResourceDefinition(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_mapping: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'OceanExtendedResourceDefinition':
        """
    ...
    @property
    @pulumi.getter(name="resourceMapping")
    def resource_mapping(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        A mapping between AWS instanceType or * as default and its value for the given extended resource.
        """
        return pulumi.get(self, "resource_mapping")
