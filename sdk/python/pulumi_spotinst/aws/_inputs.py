...
class BeanstalkDeploymentPreferencesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] grace_period: Amount of time to wait between batches
...
class BeanstalkScheduledTaskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] adjustment_percentage: The percentage of instances to add or remove.
               
               Usage:
        :param pulumi.Input[_builtins.str] batch_size_percentage: The percentage size of each batch in the scheduled deployment roll.
        ...
        :param pulumi.Input[_builtins.str] frequency: The recurrence frequency to run this task. Supported values are `"hourly"`, `"daily"`, `"weekly"` and `"continuous"`.
        :param pulumi.Input[_builtins.str] grace_period: The period of time (seconds) to wait before checking a batch's health after it's deployment.
        ...
        :param pulumi.Input[_builtins.str] scale_max_capacity: The maximum number of instances the group should have.
        :param pulumi.Input[_builtins.str] scale_min_capacity: The minimum number of instances the group should have.
        :param pulumi.Input[_builtins.str] scale_target_capacity: The desired number of instances the group should have.
        :param pulumi.Input[_builtins.str] start_time: Set a start time for one time tasks.
...
class ElastigroupCpuOptionsArgs:
    def __init__(__self__, *,
                 threads_per_core: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] threads_per_core: The ability to define the number of threads per core in instances that allow this.
        """
...
class ElastigroupEbsBlockDeviceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] encrypted: Enables [EBS encryption](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html) on the volume.
        ...
        :param pulumi.Input[_builtins.str] kms_key_id: ID for a user managed CMK under which the EBS Volume is encrypted
        ...
        :param pulumi.Input[_builtins.str] volume_type: The type of volume. Can be `"standard"`, `"gp2"`, `"gp3"`, `"io1"`, `"st1"` or `"sc1"`.
        """
...
class ElastigroupEbsBlockDeviceDynamicIopsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] size_per_resource_unit: Additional size per resource unit (in IOPS).
...
class ElastigroupEbsBlockDeviceDynamicVolumeSizeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] resource: Type of resource, valid values: `"CPU", "MEMORY"`.
        :param pulumi.Input[_builtins.int] size_per_resource_unit: Additional size per resource unit (in GB).
        """
        if base_size is not None:
            pulumi.set(__self__, "base_size", base_size)
        if resource is not None:
...
class ElastigroupImageImageArgs:
    def __init__(__self__, *,
                 id: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] id: The group ID.
        """
...
class ElastigroupInstanceTypesWeightArgs:
    def __init__(__self__, *,
                 ...
                 weight: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.str] instance_type: Name of instance type (String).
        :param pulumi.Input[_builtins.int] weight: Weight per instance type (Integer).
        """
...
class ElastigroupIntegrationCodedeployArgsDict(TypedDict):
    cleanup_on_failure: pulumi.Input[_builtins.bool]
    """
    ...
    """
    terminate_instance_on_failure: pulumi.Input[_builtins.bool]
    """
...
class ElastigroupIntegrationCodedeployArgs:
    def __init__(__self__, *,
                 ...
                 terminate_instance_on_failure: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] cleanup_on_failure: Cleanup automatically after a failed deploy.
        ...
        :param pulumi.Input[_builtins.bool] terminate_instance_on_failure: Terminate the instance automatically after a failed deploy.
        """
    ...
    def cleanup_on_failure(self) -> pulumi.Input[_builtins.bool]:
        """
        Cleanup automatically after a failed deploy.
        """
    ...
    def cleanup_on_failure(self, value: pulumi.Input[_builtins.bool]):
    ...
    def terminate_instance_on_failure(self) -> pulumi.Input[_builtins.bool]:
        """
        Terminate the instance automatically after a failed deploy.
        """
    ...
    def terminate_instance_on_failure(self, value: pulumi.Input[_builtins.bool]):
...
class ElastigroupIntegrationCodedeployDeploymentGroupArgs:
    def __init__(__self__, *,
                 ...
                 deployment_group_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] application_name: The application name.
        :param pulumi.Input[_builtins.str] deployment_group_name: The deployment group name.
...
class ElastigroupIntegrationEcsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] autoscale_scale_down_non_service_tasks: Determines whether to scale down non-service tasks.
...
class ElastigroupIntegrationEcsBatchArgsDict(TypedDict):
    job_queue_names: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]
    """
    Array of strings.
...
class ElastigroupIntegrationEcsBatchArgs:
    def __init__(__self__, *,
                 job_queue_names: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] job_queue_names: Array of strings.
    ...
    def job_queue_names(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        Array of strings.
    ...
    def job_queue_names(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class ElastigroupIntegrationKubernetesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ElastigroupIntegrationKubernetesAutoscaleLabelArgs']]] autoscale_labels: A key/value mapping of tags to assign to the resource.
               ...
               Usage:
        :param pulumi.Input[_builtins.str] integration_mode: Valid values: `"saas"`, `"pod"`.
        :param pulumi.Input[_builtins.str] token: Kubernetes Token
        """
...
class ElastigroupIntegrationMesosphereArgsDict(TypedDict):
    api_server: pulumi.Input[_builtins.str]
...
class ElastigroupIntegrationMesosphereArgs:
    ...
    @_builtins.property
    @pulumi.getter(name="apiServer")
    def api_server(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "api_server")

    @api_server.setter
    def api_server(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "api_server", value)
...
class ElastigroupIntegrationRancherArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] version: The Rancher version. Must be `"1"` or `"2"`. If this field is omitted, it’s assumed that the Rancher cluster is version 1. Note that Kubernetes is required when using Rancher version 2^.
               Usage:
        """
...
class ElastigroupIntegrationRoute53DomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] record_set_type: The type of the record set. Valid values: `"a"`, `"cname"`.
        :param pulumi.Input[_builtins.str] spotinst_acct_id: The Spotinst account ID that is linked to the AWS account that holds the Route 53 Hosted Zone ID. The default is the user Spotinst account provided as a URL parameter.
        """
...
class ElastigroupIntegrationRoute53DomainRecordSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] use_public_dns: Designates whether the DNS address should be exposed to connections outside the VPC.
               ...
               Usage:
        :param pulumi.Input[_builtins.bool] use_public_ip: Designates whether the IP address should be exposed to connections outside the VPC.
        """
...
class ElastigroupItfArgsDict(TypedDict):
    fixed_target_groups: pulumi.Input[_builtins.bool]
...
class ElastigroupItfArgs:
    ...
    def fixed_target_groups(self) -> pulumi.Input[_builtins.bool]:
        return pulumi.get(self, "fixed_target_groups")

    @fixed_target_groups.setter
    def fixed_target_groups(self, value: pulumi.Input[_builtins.bool]):
    ...
    def weight_strategy(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "weight_strategy")

    @weight_strategy.setter
    def weight_strategy(self, value: pulumi.Input[_builtins.str]):
...
class ElastigroupItfLoadBalancerListenerRuleArgs:
    ...
    def rule_arn(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "rule_arn")

    @rule_arn.setter
    def rule_arn(self, value: pulumi.Input[_builtins.str]):
...
class ElastigroupItfTargetGroupConfigArgsDict(TypedDict):
    health_check_path: pulumi.Input[_builtins.str]
...
class ElastigroupItfTargetGroupConfigArgs:
    ...
    def health_check_path(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "health_check_path")

    @health_check_path.setter
    def health_check_path(self, value: pulumi.Input[_builtins.str]):
...
class ElastigroupMetadataOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_metadata_tags: Indicates whether access to instance tags from the instance metadata is enabled or disabled. Can’t be null.
        """
...
class ElastigroupMultipleMetricsExpressionArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] expression: An expression consisting of the metric names listed in the 'metrics' array.
        :param pulumi.Input[_builtins.str] name: The group name.
        """
...
class ElastigroupNetworkInterfaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] associate_ipv6_address: Indicates whether to assign IPV6 addresses to your instance. Requires a subnet with IPV6 CIDR block ranges.
               ...
               Usage:
        :param pulumi.Input[_builtins.bool] associate_public_ip_address: Indicates whether to assign a public IP address to an instance you launch in a VPC. The public IP address can only be assigned to a network interface for eth0, and can only be assigned to a new network interface, not an existing one.
        ...
        :param pulumi.Input[_builtins.str] secondary_private_ip_address_count: The number of secondary private IP addresses.
        """
...
class ElastigroupResourceRequirementArgsDict(TypedDict):
    required_memory_maximum: pulumi.Input[_builtins.int]
    """
...
class ElastigroupResourceRequirementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] required_vcpu_maximum: Required maximum instance vCPU (<=64)
        :param pulumi.Input[_builtins.int] required_vcpu_minimum: Required minimum instance vCPU (>=1)
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] excluded_instance_families: Instance families to exclude
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] excluded_instance_generations: Instance generations to exclude
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] excluded_instance_types: Instance types to exclude
        :param pulumi.Input[_builtins.int] required_gpu_maximum: Required maximum instance GPU (<=16)
        :param pulumi.Input[_builtins.int] required_gpu_minimum: Required minimum instance GPU (>=1)
        """
    ...
    def required_memory_maximum(self) -> pulumi.Input[_builtins.int]:
        """
        Required maximum instance memory (<=512)
        """
    ...
    def required_memory_maximum(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "required_memory_maximum", value)

    @_builtins.property
    @pulumi.getter(name="requiredMemoryMinimum")
    def required_memory_minimum(self) -> pulumi.Input[_builtins.int]:
        """
        Required minimum instance memory (>=1)
        """
    ...
    def required_memory_minimum(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "required_memory_minimum", value)

    @_builtins.property
    @pulumi.getter(name="requiredVcpuMaximum")
    def required_vcpu_maximum(self) -> pulumi.Input[_builtins.int]:
        """
        Required maximum instance vCPU (<=64)
        """
    ...
    def required_vcpu_maximum(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "required_vcpu_maximum", value)

    @_builtins.property
    @pulumi.getter(name="requiredVcpuMinimum")
    def required_vcpu_minimum(self) -> pulumi.Input[_builtins.int]:
        """
        Required minimum instance vCPU (>=1)
        """
    ...
    def required_vcpu_minimum(self, value: pulumi.Input[_builtins.int]):
...
class ElastigroupResourceTagSpecificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] should_tag_snapshots: Tag specification for Snapshot resources.
        :param pulumi.Input[_builtins.bool] should_tag_volumes: Tag specification for Volume resources.
        """
...
class ElastigroupScalingDownPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] action_type: The type of action to perform for scaling. Valid values: `"adjustment"`, `"percentageAdjustment"`, `"setMaxTarget"`, `"setMinTarget"`, `"updateCapacity"`. If a `step_adjustment` object is defined, then it cannot be specified.
        :param pulumi.Input[_builtins.str] adjustment: The number of instances to add/remove to/from the target capacity when scale is needed. Can be used as advanced expression for scaling of instances to add/remove to/from the target capacity when scale is needed. You can see more information here: Advanced expression. Example value: `"MAX(currCapacity / 5, value * 10)"`
        :param pulumi.Input[_builtins.int] cooldown: The amount of time, in seconds, after a scaling activity completes and before the next scaling activity can start. If this parameter is not specified, the default cooldown period for the group applies.
        ...
        :param pulumi.Input[_builtins.bool] is_enabled: Specifies whether the scaling policy described in this block is enabled.
        :param pulumi.Input[_builtins.str] max_target_capacity: . The number of the desired target (and maximum) capacity
        :param pulumi.Input[_builtins.str] maximum: The maximal number of instances to have in the group.
        :param pulumi.Input[_builtins.str] minimum: The minimal number of instances to have in the group.
        :param pulumi.Input[_builtins.str] operator: The operator to use in order to determine if the scaling policy is applicable. Valid values: `"gt"`, `"gte"`, `"lt"`, `"lte"`.
        :param pulumi.Input[_builtins.int] period: The granularity, in seconds, of the returned datapoints. Period must be at least 60 seconds and must be a multiple of 60.
        :param pulumi.Input[_builtins.str] source: The source of the metric. Valid values: `"cloudWatch"`, `"spectrum"`.
        :param pulumi.Input[_builtins.str] statistic: The metric statistics to return. For information about specific statistics go to [Statistics](http://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/index.html?CHAP_TerminologyandKeyConcepts.html#Statistic) in the Amazon CloudWatch Developer Guide.
        :param pulumi.Input[_builtins.str] target: The target number of instances to have in the group.
        :param pulumi.Input[_builtins.float] threshold: The value against which the specified statistic is compared. If a `step_adjustment` object is defined, then it cannot be specified.
        :param pulumi.Input[_builtins.str] unit: The unit for the alarm's associated metric. Valid values: `"percent`, `"seconds"`, `"microseconds"`, `"milliseconds"`, `"bytes"`, `"kilobytes"`, `"megabytes"`, `"gigabytes"`, `"terabytes"`, `"bits"`, `"kilobits"`, `"megabits"`, `"gigabits"`, `"terabits"`, `"count"`, `"bytes/second"`, `"kilobytes/second"`, `"megabytes/second"`, `"gigabytes/second"`, `"terabytes/second"`, `"bits/second"`, `"kilobits/second"`, `"megabits/second"`, `"gigabits/second"`, `"terabits/second"`, `"count/second"`, `"none"`.
        """
        pulumi.set(__self__, "metric_name", metric_name)
        pulumi.set(__self__, "namespace", namespace)
...
class ElastigroupScalingTargetPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] policy_name: String, the name of the policy.
        :param pulumi.Input[_builtins.float] target: The target number of instances to have in the group.
        :param pulumi.Input[_builtins.int] cooldown: Integer the amount of time, in seconds, after a scaling activity completes and before the next scaling activity can start. If this parameter is not specified, the default cooldown period for the group applies.
        ...
        :param pulumi.Input[_builtins.int] evaluation_periods: The number of periods over which data is compared to the specified threshold.
        :param pulumi.Input[_builtins.str] max_capacity_per_scale: String, restrict the maximal number of instances which can be added in each scale-up action.
               
               `scaling_target_policies` support predictive scaling:
        :param pulumi.Input[_builtins.int] period: The granularity, in seconds, of the returned datapoints. Period must be at least 60 seconds and must be a multiple of 60.
        :param pulumi.Input[_builtins.str] predictive_mode: Start a metric prediction process to determine the expected target metric value within the next two days. See [Predictive Autoscaling](https://api.spotinst.com/elastigroup-for-aws/concepts/scaling-concepts/predictive-autoscaling/) documentation for more info. Valid values: `FORECAST_AND_SCALE`, `FORECAST_ONLY`.
               
               Usage:
        :param pulumi.Input[_builtins.str] source: String, the source of the metric. Valid values: `"cloudWatch"`, `"spectrum"`.
        :param pulumi.Input[_builtins.str] statistic: String, the metric statistics to return. For information about specific statistics go to [Statistics](http://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/index.html?CHAP_TerminologyandKeyConcepts.html#Statistic) in the Amazon CloudWatch Developer Guide.
        :param pulumi.Input[_builtins.str] unit: String, tThe unit for the alarm's associated metric. Valid values: `"percent`, `"seconds"`, `"microseconds"`, `"milliseconds"`, `"bytes"`, `"kilobytes"`, `"megabytes"`, `"gigabytes"`, `"terabytes"`, `"bits"`, `"kilobits"`, `"megabits"`, `"gigabits"`, `"terabits"`, `"count"`, `"bytes/second"`, `"kilobytes/second"`, `"megabytes/second"`, `"gigabytes/second"`, `"terabytes/second"`, `"bits/second"`, `"kilobits/second"`, `"megabits/second"`, `"gigabits/second"`, `"terabits/second"`, `"count/second"`, `"none"`.
        """
        pulumi.set(__self__, "metric_name", metric_name)
        pulumi.set(__self__, "namespace", namespace)
        pulumi.set(__self__, "policy_name", policy_name)
...
class ElastigroupScalingUpPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_enabled: Specifies whether the scaling policy described in this block is enabled.
        :param pulumi.Input[_builtins.str] maximum: The maximal number of instances to have in the group.
        :param pulumi.Input[_builtins.str] min_target_capacity: . The number of the desired target (and minimum) capacity
        :param pulumi.Input[_builtins.str] minimum: The minimal number of instances to have in the group.
        :param pulumi.Input[_builtins.str] operator: The operator to use in order to determine if the scaling policy is applicable. Valid values: `"gt"`, `"gte"`, `"lt"`, `"lte"`.
        :param pulumi.Input[_builtins.int] period: The granularity, in seconds, of the returned datapoints. Period must be at least 60 seconds and must be a multiple of 60.
        :param pulumi.Input[_builtins.str] source: The source of the metric. Valid values: `"cloudWatch"`, `"spectrum"`.
...
class ElastigroupStatefulDeallocationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] should_delete_snapshots: For stateful groups: remove snapshots.
               
               Usage:
        :param pulumi.Input[_builtins.bool] should_delete_volumes: For stateful groups: remove persistent volumes.
        """
...
class ElastigroupStatefulInstanceActionArgsDict(TypedDict):
    stateful_instance_id: pulumi.Input[_builtins.str]
    """
...
class ElastigroupStatefulInstanceActionArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] stateful_instance_id: String, Stateful Instance ID on which the action should be performed.
        :param pulumi.Input[_builtins.str] type: String, Action type. Supported action types: `pause`, `resume`, `recycle`, `deallocate`.
    ...
    def stateful_instance_id(self) -> pulumi.Input[_builtins.str]:
        """
        String, Stateful Instance ID on which the action should be performed.
        """
    ...
    def stateful_instance_id(self, value: pulumi.Input[_builtins.str]):
...
class ElastigroupUpdatePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] auto_apply_tags: Enables updates to tags without rolling the group when set to `true`.
    ...
    def should_resume_stateful(self) -> pulumi.Input[_builtins.bool]:
        """
        This will apply resuming action for Stateful instances in the Elastigroup upon scale up or capacity changes. Example usage will be for Elastigroups that will have scheduling rules to set a target capacity of 0 instances in the night and automatically restore the same state of the instances in the morning.
        """
    ...
    def should_resume_stateful(self, value: pulumi.Input[_builtins.bool]):
...
class ElastigroupUpdatePolicyRollConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] health_check_type: Sets the health check type to use. Valid values: `"EC2"`, `"ECS_CLUSTER_INSTANCE"`, `"ELB"`, `"HCS"`, `"TARGET_GROUP"`, `"NONE"`.
        :param pulumi.Input['ElastigroupUpdatePolicyRollConfigStrategyArgs'] strategy: Strategy parameters
        :param pulumi.Input[_builtins.float] wait_for_roll_percentage: For use with `should_roll`. Sets minimum % of roll required to complete before continuing the plan. Required if `wait_for_roll_timeout` is set.
        :param pulumi.Input[_builtins.int] wait_for_roll_timeout: For use with `should_roll`. Sets how long to wait for the deployed % of a roll to exceed `wait_for_roll_percentage` before continuing the plan. Required if `wait_for_roll_percentage` is set.
        """
        pulumi.set(__self__, "batch_size_percentage", batch_size_percentage)
        if grace_period is not None:
            pulumi.set(__self__, "grace_period", grace_period)
...
class ElastigroupUpdatePolicyRollConfigStrategyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] should_drain_instances: Specify whether to drain incoming TCP connections before terminating a server.
        """
        pulumi.set(__self__, "action", action)
...
class ElastigroupUpdatePolicyRollConfigStrategyOnFailureArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] should_decrement_target_capacity: Decrementing the group target capacity after detaching the instances.
        :param pulumi.Input[_builtins.bool] should_handle_all_batches: Indicator if the action should apply to all batches of the deployment or only the latest batch.
        """
        pulumi.set(__self__, "action_type", action_type)
...
class MrScalarApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] version: T he version of the application.
        """
        pulumi.set(__self__, "name", name)
        if args is not None:
...
class MrScalarCoreScalingDownPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] adjustment: The number of instances to add/remove to/from the target capacity when scale is needed.
        :param pulumi.Input[_builtins.int] cooldown: The amount of time, in seconds, after a scaling activity completes and before the next scaling activity can start.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] dimensions: A mapping of dimensions describing qualities of the metric.
        :param pulumi.Input[_builtins.str] max_target_capacity: Max target capacity for scale down.
        :param pulumi.Input[_builtins.str] maximum: The maximum to set when scale is needed.
        :param pulumi.Input[_builtins.str] min_target_capacity: Min target capacity for scale up.
        :param pulumi.Input[_builtins.str] minimum: The minimum to set when scale is needed.
        :param pulumi.Input[_builtins.str] target: The number of instances to set when scale is needed.
        """
        pulumi.set(__self__, "metric_name", metric_name)
        pulumi.set(__self__, "namespace", namespace)
        pulumi.set(__self__, "policy_name", policy_name)
...
class MrScalarInstanceWeightArgsDict(TypedDict):
    ...
    """
    weighted_capacity: pulumi.Input[_builtins.int]
    """
...
class MrScalarInstanceWeightArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] weighted_capacity: The weight given to the associated instance type.
        """
        pulumi.set(__self__, "instance_type", instance_type)
    ...
    def weighted_capacity(self) -> pulumi.Input[_builtins.int]:
        """
        The weight given to the associated instance type.
        """
    ...
    def weighted_capacity(self, value: pulumi.Input[_builtins.int]):
...
class MrScalarProvisioningTimeoutArgs:
    def __init__(__self__, *,
                 ...
                 timeout_action: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.int] timeout: The amount of time (minutes) after which the cluster is automatically terminated if it's still in provisioning status. Minimum: '15'.
        :param pulumi.Input[_builtins.str] timeout_action: The action to take if the timeout is exceeded. Valid values: `terminate`, `terminateAndRetry`.
        """
        pulumi.set(__self__, "timeout", timeout)
...
class MrScalarScheduledTaskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] task_type: The type of task to be scheduled. Valid values: `setCapacity`.
        :param pulumi.Input[_builtins.str] desired_capacity: New desired capacity for the elastigroup.
        :param pulumi.Input[_builtins.bool] is_enabled: Enable/Disable the specified scheduling task.
        :param pulumi.Input[_builtins.str] max_capacity: New max capacity for the elastigroup.
        :param pulumi.Input[_builtins.str] min_capacity: New min capacity for the elastigroup.
        """
...
class MrScalarTerminationPolicyStatementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] threshold: The value that the specified statistic is compared to.
        :param pulumi.Input[_builtins.int] evaluation_periods: The number of periods over which data is compared to the specified threshold.
        :param pulumi.Input[_builtins.str] operator: The operator to use in order to determine if the policy is applicable. Valid values: `gt` | `gte` | `lt` | `lte`
        :param pulumi.Input[_builtins.int] period: The time window in seconds over which the statistic is applied.
        :param pulumi.Input[_builtins.str] statistic: The aggregation method of the given metric. Valid Values: `average` | `sum` | `sampleCount` | `maximum` | `minimum`
        :param pulumi.Input[_builtins.str] unit: The unit for a given metric. Valid Values: `seconds` | `microseconds` | `milliseconds` | `bytes` | `kilobytes` | `megabytes` | `gigabytes` | `terabytes` | `bits` | `kilobits` | `megabits` | `gigabits` | `terabits` | `percent` | `count` | `bytes/second` | `kilobytes/second` | `megabytes/second` | `gigabytes/second` | `terabytes/second` | `bits/second` | `kilobits/second` | `megabits/second` | `gigabits/second` | `terabits/second` | `count/second` | `none`
        """
        pulumi.set(__self__, "metric_name", metric_name)
        pulumi.set(__self__, "namespace", namespace)
        pulumi.set(__self__, "threshold", threshold)
...
class OceanAttachLoadBalancerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: If type is "CLASSIC" then a name is required. Otherwise is not allowed.
        """
        pulumi.set(__self__, "type", type)
        if arn is not None:
            pulumi.set(__self__, "arn", arn)
...
class OceanAutoscalerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] autoscale_is_auto_config: Automatically configure and optimize headroom resources.
        :param pulumi.Input[_builtins.bool] autoscale_is_enabled: Enable the Ocean Kubernetes Auto Scaler.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] extended_resource_definitions: List of Ocean extended resource definitions to use in this cluster.
...
class OceanBlockDeviceMappingEbsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] iops: Must be greater than or equal to 0.
...
class OceanLaunchSpecBlockDeviceMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] no_device: String. Suppresses the specified device included in the block device mapping of the AMI. Default value is set to `unset` intentionally, which will appear in the terminal during a pulumi preview if this field is not configured or removed. This prevents confusion, as Terraform otherwise considers empty string as null.
        """
        if device_name is not None:
            pulumi.set(__self__, "device_name", device_name)
        if ebs is not None:
...
class OceanLaunchSpecDeleteOptionsArgs:
    ...
    def force_delete(self) -> pulumi.Input[_builtins.bool]:
        """
        When set to `true`, delete even if it is the last Virtual Node Group (also, the default Virtual Node Group must be configured with `useAsTemlateOnly = true`). Should be set at creation or update, but will be used only at deletion.
        """
    ...
    @force_delete.setter
    def force_delete(self, value: pulumi.Input[_builtins.bool]):
...
class OceanLaunchSpecInstanceTypesFiltersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] exclude_families: Types belonging to a family from the ExcludeFamilies will not be available for scaling (asterisk wildcard is also supported). For example, C* will exclude instance types from these families: c5, c4, c4a, etc.
        :param pulumi.Input[_builtins.bool] exclude_metal: In case excludeMetal is set to true, metal types will not be available for scaling.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] hypervisors: The filtered instance types will have a hypervisor type from this list. Valid values: `nitro`, `xen`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] include_families: Types belonging to a family from the IncludeFamilies will be available for scaling (asterisk wildcard is also supported). For example, C* will include instance types from these families: c5, c4, c4a, etc.
        :param pulumi.Input[_builtins.str] is_ena_supported: Ena is supported or not.
        :param pulumi.Input[_builtins.int] max_gpu: Maximum total number of GPUs.
        ...
        :param pulumi.Input[_builtins.int] min_network_performance: Minimum Bandwidth in Gib/s of network performance.
        :param pulumi.Input[_builtins.int] min_vcpu: Minimum number of vcpus available.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] root_device_types: The filtered instance types will have a root device types from this list. Valid values: `ebs`, or `instance-store`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] virtualization_types: The filtered instance types will support at least one of the virtualization types from this list. Valid values: `hvm`, `paravirtual`.
        """
        if categories is not None:
            pulumi.set(__self__, "categories", categories)
        if disk_types is not None:
...
class OceanLaunchSpecStartupTaintArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] value: Set startup taint value.
        """
...
class OceanLaunchSpecStrategyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] spot_percentage: The desired percentage of the Spot instances out of all running instances for this VNG. Only available when the field is not set in the cluster directly (cluster.strategy.spotPercentage).
        :param pulumi.Input[_builtins.bool] utilize_commitments: When set as ‘true’, if savings plans commitments have available capacity, Ocean will utilize them alongside RIs (if exist) to maximize cost efficiency. If the value is set as 'null', it will automatically be inherited from the cluster level.
        :param pulumi.Input[_builtins.bool] utilize_reserved_instances: When set as ‘true’, if reserved instances exist, Ocean will utilize them before launching spot instances. If the value is set as 'null', it will automatically be inherited from the cluster level.
        """
        if draining_timeout is not None:
            pulumi.set(__self__, "draining_timeout", draining_timeout)
...
class OceanScheduledTaskTaskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] task_type: Valid values: `clusterRoll` `amiAutoUpdate`. Required for `cluster.scheduling.tasks`
...
class OceanScheduledTaskTaskParametersAmiAutoUpdateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] minor_version: When set to 'true', the auto-update process will update the VNGs’ AMI with the AMI to match the Kubernetes control plane version. either "patch" or "minor_version" must be true.
        :param pulumi.Input[_builtins.bool] patch: When set to 'true', the auto-update process will update the VNGs’ images with the latest security patches. either "patch" or "minorVersion" must be true.
        """
...
class OceanUpdatePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] conditioned_roll_params: A custom list of attributes will trigger the cluster roll operation (overrides the predefined list of parameters). Valid only when the `conditioned_roll` parameter is set to true. (Valid values: `"subnet_ids"`,`"whitelist"`,`"blacklist"`,`"user_data"`,`"image_id"`,`"security_groups"`,`"key_name"`,`"iam_instance_profile"`,`"associate_public_ip_address"`,`"load_balancers"`,`"instance_metadata_options"`,`"ebs_optimized"`,`"root_volume_size"`)
...
class SuspensionSuspensionArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] name: The name of process to suspend. Valid values: `"AUTO_HEALING" , "OUT_OF_STRATEGY", "PREVENTIVE_REPLACEMENT", "REVERT_PREFERRED", or "SCHEDULING"`.
        """
        pulumi.set(__self__, "name", name)
