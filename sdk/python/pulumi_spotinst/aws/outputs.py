...
class BeanstalkDeploymentPreferences(dict):
    ...
    def __init__(__self__, *,
                 automatic_roll: Optional[builtins.bool] = None,
        ...
        """
        :param builtins.bool automatic_roll: Should roll perform automatically
        :param builtins.int batch_size_percentage: Percent size of each batch
        :param builtins.int grace_period: Amount of time to wait between batches
    ...
    def automatic_roll(self) -> Optional[builtins.bool]:
        """
...
class BeanstalkDeploymentPreferencesStrategy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 should_drain_instances: Optional[builtins.bool] = None):
        """
        :param builtins.str action: Action to take
        :param builtins.bool should_drain_instances: Bool value if to wait to drain instance
        """
    ...
    def should_drain_instances(self) -> Optional[builtins.bool]:
        """
...
class BeanstalkManagedActionsPlatformUpdate(dict):
    ...
    def __init__(__self__, *,
                 perform_at: Optional[builtins.str] = None,
                 time_window: Optional[builtins.str] = None,
                 update_level: Optional[builtins.str] = None):
        """
        :param builtins.str perform_at: Actions to perform (options: timeWindow, never)
        :param builtins.str time_window: Time Window for when action occurs ex. Mon:23:50-Tue:00:20
        :param builtins.str update_level: Level to update
        """
    ...
    def perform_at(self) -> Optional[builtins.str]:
        """
    ...
    def update_level(self) -> Optional[builtins.str]:
        """
        Level to update
        """
...
class BeanstalkScheduledTask(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str task_type: The task type to run. Supported task types are: `"scale"`, `"backup_ami"`, `"roll"`, `"scaleUp"`, `"percentageScaleUp"`, `"scaleDown"`, `"percentageScaleDown"`, `"statefulUpdateCapacity"`.
        :param builtins.str adjustment: The number of instances to add or remove.
        :param builtins.str adjustment_percentage: The percentage of instances to add or remove.
               
               Usage:
        :param builtins.str batch_size_percentage: The percentage size of each batch in the scheduled deployment roll.
        ...
        :param builtins.str frequency: The recurrence frequency to run this task. Supported values are `"hourly"`, `"daily"`, `"weekly"` and `"continuous"`.
        :param builtins.str grace_period: The period of time (seconds) to wait before checking a batch's health after it's deployment.
        ...
        :param builtins.str scale_max_capacity: The maximum number of instances the group should have.
        :param builtins.str scale_min_capacity: The minimum number of instances the group should have.
        :param builtins.str scale_target_capacity: The desired number of instances the group should have.
        :param builtins.str start_time: Set a start time for one time tasks.
...
class ElastigroupCpuOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int threads_per_core: The ability to define the number of threads per core in instances that allow this.
        """
...
class ElastigroupEbsBlockDevice(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str device_name: The name of the device to mount.
        :param builtins.bool delete_on_termination: Whether the volume should be destroyed on instance termination.
        ...
        :param builtins.bool encrypted: Enables [EBS encryption](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html) on the volume.
        :param builtins.int iops: The amount of provisioned [IOPS](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-io-characteristics.html). This must be set with a `volume_type` of `"io1"`.
        :param builtins.str kms_key_id: ID for a user managed CMK under which the EBS Volume is encrypted
        ...
        :param builtins.str volume_type: The type of volume. Can be `"standard"`, `"gp2"`, `"gp3"`, `"io1"`, `"st1"` or `"sc1"`.
        """
...
class ElastigroupEbsBlockDeviceDynamicIops(dict):
    ...
    def __init__(__self__, *,
                 base_size: Optional[builtins.int] = None,
                 resource: Optional[builtins.str] = None,
                 size_per_resource_unit: Optional[builtins.int] = None):
        """
        :param builtins.int base_size: Initial size for IOPS.
        :param builtins.str resource: Type of resource, valid values: `"CPU", "MEMORY"`.
        :param builtins.int size_per_resource_unit: Additional size per resource unit (in IOPS).
    ...
    def base_size(self) -> Optional[builtins.int]:
        """
    ...
    def size_per_resource_unit(self) -> Optional[builtins.int]:
        """
...
class ElastigroupEbsBlockDeviceDynamicVolumeSize(dict):
    ...
    def __init__(__self__, *,
                 ...
                 size_per_resource_unit: Optional[builtins.int] = None):
        """
        :param builtins.int base_size: Initial size for volume.
        :param builtins.str resource: Type of resource, valid values: `"CPU", "MEMORY"`.
        :param builtins.int size_per_resource_unit: Additional size per resource unit (in GB).
        """
        if base_size is not None:
            pulumi.set(__self__, "base_size", base_size)
        if resource is not None:
...
class ElastigroupEphemeralBlockDevice(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str device_name: The name of the block device to mount on the instance.
        :param builtins.str virtual_name: The [Instance Store Device Name](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/InstanceStorage.html#InstanceStoreDeviceNames)
               (e.g. `"ephemeral0"`).
...
class ElastigroupInstanceTypesWeight(dict):
    ...
    def __init__(__self__, *,
                 ...
                 weight: builtins.int):
        """
        :param builtins.str instance_type: Name of instance type (String).
        :param builtins.int weight: Weight per instance type (Integer).
        """
...
class ElastigroupIntegrationCodedeploy(dict):
    ...
    def __init__(__self__, *,
                 cleanup_on_failure: builtins.bool,
        ...
        """
        :param builtins.bool cleanup_on_failure: Cleanup automatically after a failed deploy.
        ...
        :param builtins.bool terminate_instance_on_failure: Terminate the instance automatically after a failed deploy.
        """
    ...
    def cleanup_on_failure(self) -> builtins.bool:
        """
...
class ElastigroupIntegrationCodedeployDeploymentGroup(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str application_name: The application name.
        :param builtins.str deployment_group_name: The deployment group name.
...
class ElastigroupIntegrationEcs(dict):
    ...
    def __init__(__self__, *,
                 ...
                 autoscale_is_enabled: Optional[builtins.bool] = None,
                 autoscale_scale_down_non_service_tasks: Optional[builtins.bool] = None,
                 batch: Optional['outputs.ElastigroupIntegrationEcsBatch'] = None):
        """
        :param builtins.str cluster_name: The name of the EC2 Container Service cluster.
        ...
        :param builtins.bool autoscale_scale_down_non_service_tasks: Determines whether to scale down non-service tasks.
    ...
    def autoscale_scale_down_non_service_tasks(self) -> Optional[builtins.bool]:
        """
...
class ElastigroupIntegrationEcsBatch(dict):
    ...
    def __init__(__self__, *,
                 job_queue_names: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] job_queue_names: Array of strings.
    ...
    def job_queue_names(self) -> Sequence[builtins.str]:
        """
        Array of strings.
...
class ElastigroupIntegrationKubernetes(dict):
    ...
    def __init__(__self__, *,
                 api_server: Optional[builtins.str] = None,
                 autoscale_cooldown: Optional[builtins.int] = None,
                 ...
                 integration_mode: Optional[builtins.str] = None,
        ...
        :param Sequence['ElastigroupIntegrationKubernetesAutoscaleLabelArgs'] autoscale_labels: A key/value mapping of tags to assign to the resource.
               ...
               Usage:
        :param builtins.str integration_mode: Valid values: `"saas"`, `"pod"`.
        :param builtins.str token: Kubernetes Token
        """
    ...
    def api_server(self) -> Optional[builtins.str]:
    ...
    def integration_mode(self) -> Optional[builtins.str]:
        """
...
class ElastigroupIntegrationNomad(dict):
    ...
    def __init__(__self__, *,
                 master_host: builtins.str,
                 master_port: builtins.int,
                 acl_token: Optional[builtins.str] = None,
                 ...
                 autoscale_is_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str acl_token: Nomad ACL Token
    ...
    def acl_token(self) -> Optional[builtins.str]:
        """
        Nomad ACL Token
        """
...
class ElastigroupIntegrationRancher(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str access_key: The access key of the Rancher API.
        :param builtins.str secret_key: The secret key of the Rancher API.
        :param builtins.str version: The Rancher version. Must be `"1"` or `"2"`. If this field is omitted, it’s assumed that the Rancher cluster is version 1. Note that Kubernetes is required when using Rancher version 2^.
               Usage:
        """
...
class ElastigroupIntegrationRoute53Domain(dict):
    ...
    def __init__(__self__, *,
                 ...
                 record_set_type: Optional[builtins.str] = None,
                 spotinst_acct_id: Optional[builtins.str] = None):
        """
        :param builtins.str hosted_zone_id: The id associated with a hosted zone.
        ...
        :param builtins.str record_set_type: The type of the record set. Valid values: `"a"`, `"cname"`.
        :param builtins.str spotinst_acct_id: The Spotinst account ID that is linked to the AWS account that holds the Route 53 Hosted Zone ID. The default is the user Spotinst account provided as a URL parameter.
        """
    ...
    def record_set_type(self) -> Optional[builtins.str]:
        """
    ...
    def spotinst_acct_id(self) -> Optional[builtins.str]:
        """
...
class ElastigroupIntegrationRoute53DomainRecordSet(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 use_public_dns: Optional[builtins.bool] = None,
                 use_public_ip: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The group name.
        :param builtins.bool use_public_dns: Designates whether the DNS address should be exposed to connections outside the VPC.
               
               Usage:
        :param builtins.bool use_public_ip: Designates whether the IP address should be exposed to connections outside the VPC.
        """
    ...
    def use_public_dns(self) -> Optional[builtins.bool]:
        """
    ...
    def use_public_ip(self) -> Optional[builtins.bool]:
        """
...
class ElastigroupItf(dict):
    ...
    def __init__(__self__, *,
                 fixed_target_groups: builtins.bool,
                 ...
                 migration_healthiness_threshold: Optional[builtins.int] = None):
    ...
    def fixed_target_groups(self) -> builtins.bool:
    ...
    def migration_healthiness_threshold(self) -> Optional[builtins.int]:
...
class ElastigroupItfTargetGroupConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 health_check_port: Optional[builtins.str] = None,
...
class ElastigroupItfTargetGroupConfigMatcher(dict):
    ...
    def __init__(__self__, *,
                 grpc_code: Optional[builtins.str] = None,
    ...
    def grpc_code(self) -> Optional[builtins.str]:
...
class ElastigroupMetadataOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str http_tokens: The state of token usage for your instance metadata requests. Valid values: `optional` or `required`.
        :param builtins.int http_put_response_hop_limit: The desired HTTP PUT response hop limit for instance metadata requests. The larger the number, the further instance metadata requests can travel. Valid values: Integers from `1` to `64`.
        :param builtins.str instance_metadata_tags: Indicates whether access to instance tags from the instance metadata is enabled or disabled. Can’t be null.
        """
...
class ElastigroupMultipleMetricsExpression(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str expression: An expression consisting of the metric names listed in the 'metrics' array.
        :param builtins.str name: The group name.
        """
...
class ElastigroupMultipleMetricsMetric(dict):
    ...
    def __init__(__self__, *,
                 ...
                 extended_statistic: Optional[builtins.str] = None,
                 statistic: Optional[builtins.str] = None,
                 unit: Optional[builtins.str] = None):
        """
        :param builtins.str name: The group name.
        :param builtins.str extended_statistic: Percentile statistic. Valid values: `"p0.1"` - `"p100"`.
        """
...
class ElastigroupNetworkInterface(dict):
    ...
    def __init__(__self__, *,
                 ...
                 associate_ipv6_address: Optional[builtins.bool] = None,
                 ...
                 secondary_private_ip_address_count: Optional[builtins.str] = None):
        """
        :param builtins.str device_index: The index of the device on the instance for the network interface attachment.
        :param builtins.bool associate_ipv6_address: Indicates whether to assign IPV6 addresses to your instance. Requires a subnet with IPV6 CIDR block ranges.
               
               Usage:
        :param builtins.bool associate_public_ip_address: Indicates whether to assign a public IP address to an instance you launch in a VPC. The public IP address can only be assigned to a network interface for eth0, and can only be assigned to a new network interface, not an existing one.
        ...
        :param builtins.str secondary_private_ip_address_count: The number of secondary private IP addresses.
        """
    ...
    def associate_ipv6_address(self) -> Optional[builtins.bool]:
        """
    ...
    def secondary_private_ip_address_count(self) -> Optional[builtins.str]:
        """
...
class ElastigroupResourceRequirement(dict):
    ...
    def __init__(__self__, *,
                 required_memory_maximum: builtins.int,
                 required_memory_minimum: builtins.int,
                 required_vcpu_maximum: builtins.int,
                 required_vcpu_minimum: builtins.int,
                 excluded_instance_families: Optional[Sequence[builtins.str]] = None,
                 excluded_instance_generations: Optional[Sequence[builtins.str]] = None,
                 excluded_instance_types: Optional[Sequence[builtins.str]] = None,
                 required_gpu_maximum: Optional[builtins.int] = None,
                 required_gpu_minimum: Optional[builtins.int] = None):
        """
        :param builtins.int required_memory_maximum: Required maximum instance memory (<=512)
        :param builtins.int required_memory_minimum: Required minimum instance memory (>=1)
        :param builtins.int required_vcpu_maximum: Required maximum instance vCPU (<=64)
        :param builtins.int required_vcpu_minimum: Required minimum instance vCPU (>=1)
        :param Sequence[builtins.str] excluded_instance_families: Instance families to exclude
        :param Sequence[builtins.str] excluded_instance_generations: Instance generations to exclude
        :param Sequence[builtins.str] excluded_instance_types: Instance types to exclude
        :param builtins.int required_gpu_maximum: Required maximum instance GPU (<=16)
        :param builtins.int required_gpu_minimum: Required minimum instance GPU (>=1)
        """
    ...
    def required_memory_maximum(self) -> builtins.int:
        """
    ...
    def required_memory_minimum(self) -> builtins.int:
        """
    ...
    def required_vcpu_maximum(self) -> builtins.int:
        """
    ...
    def required_vcpu_minimum(self) -> builtins.int:
        """
    ...
    def excluded_instance_families(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def excluded_instance_generations(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def required_gpu_maximum(self) -> Optional[builtins.int]:
        """
    ...
    def required_gpu_minimum(self) -> Optional[builtins.int]:
        """
...
class ElastigroupResourceTagSpecification(dict):
    ...
    def __init__(__self__, *,
                 should_tag_amis: Optional[builtins.bool] = None,
                 should_tag_enis: Optional[builtins.bool] = None,
                 should_tag_snapshots: Optional[builtins.bool] = None,
                 should_tag_volumes: Optional[builtins.bool] = None):
        """
        :param builtins.bool should_tag_amis: Tag specification for AMI resources.
        :param builtins.bool should_tag_enis: Tag specification for ENI resources.
        :param builtins.bool should_tag_snapshots: Tag specification for Snapshot resources.
        :param builtins.bool should_tag_volumes: Tag specification for Volume resources.
        """
    ...
    def should_tag_amis(self) -> Optional[builtins.bool]:
        """
    ...
    def should_tag_enis(self) -> Optional[builtins.bool]:
        """
    ...
    def should_tag_snapshots(self) -> Optional[builtins.bool]:
        """
    ...
    def should_tag_volumes(self) -> Optional[builtins.bool]:
        """
...
class ElastigroupRevertToSpot(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str perform_at: In the event of a fallback to On-Demand instances, select the time period to revert back to Spot. Supported Arguments – always (default), timeWindow, never. For timeWindow or never to be valid the group must have availabilityOriented OR persistence defined.
        :param Sequence[builtins.str] time_windows: Specify a list of time windows for to execute revertToSpot strategy. Time window format: `ddd:hh:mm-ddd:hh:mm`. Example: `Mon:03:00-Wed:02:30`
        """
        pulumi.set(__self__, "perform_at", perform_at)
...
class ElastigroupScalingDownPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 evaluation_periods: Optional[builtins.int] = None,
                 is_enabled: Optional[builtins.bool] = None,
                 max_target_capacity: Optional[builtins.str] = None,
                 maximum: Optional[builtins.str] = None,
                 min_target_capacity: Optional[builtins.str] = None,
                 ...
                 unit: Optional[builtins.str] = None):
        """
        :param builtins.str metric_name: The name of the metric, with or without spaces.
        :param builtins.str namespace: The namespace for the alarm's associated metric.
        :param builtins.str policy_name: The name of the policy.
        :param builtins.str action_type: The type of action to perform for scaling. Valid values: `"adjustment"`, `"percentageAdjustment"`, `"setMaxTarget"`, `"setMinTarget"`, `"updateCapacity"`. If a `step_adjustment` object is defined, then it cannot be specified.
        :param builtins.str adjustment: The number of instances to add/remove to/from the target capacity when scale is needed. Can be used as advanced expression for scaling of instances to add/remove to/from the target capacity when scale is needed. You can see more information here: Advanced expression. Example value: `"MAX(currCapacity / 5, value * 10)"`
        :param builtins.int cooldown: The amount of time, in seconds, after a scaling activity completes and before the next scaling activity can start. If this parameter is not specified, the default cooldown period for the group applies.
        ...
        :param builtins.int evaluation_periods: The number of periods over which data is compared to the specified threshold.
        :param builtins.bool is_enabled: Specifies whether the scaling policy described in this block is enabled.
        :param builtins.str max_target_capacity: . The number of the desired target (and maximum) capacity
        :param builtins.str maximum: The maximal number of instances to have in the group.
        :param builtins.str minimum: The minimal number of instances to have in the group.
        :param builtins.str operator: The operator to use in order to determine if the scaling policy is applicable. Valid values: `"gt"`, `"gte"`, `"lt"`, `"lte"`.
        :param builtins.int period: The granularity, in seconds, of the returned datapoints. Period must be at least 60 seconds and must be a multiple of 60.
        :param builtins.str source: The source of the metric. Valid values: `"cloudWatch"`, `"spectrum"`.
        :param builtins.str statistic: The metric statistics to return. For information about specific statistics go to [Statistics](http://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/index.html?CHAP_TerminologyandKeyConcepts.html#Statistic) in the Amazon CloudWatch Developer Guide.
        :param builtins.str target: The target number of instances to have in the group.
        :param builtins.float threshold: The value against which the specified statistic is compared. If a `step_adjustment` object is defined, then it cannot be specified.
        :param builtins.str unit: The unit for the alarm's associated metric. Valid values: `"percent`, `"seconds"`, `"microseconds"`, `"milliseconds"`, `"bytes"`, `"kilobytes"`, `"megabytes"`, `"gigabytes"`, `"terabytes"`, `"bits"`, `"kilobits"`, `"megabits"`, `"gigabits"`, `"terabits"`, `"count"`, `"bytes/second"`, `"kilobytes/second"`, `"megabytes/second"`, `"gigabytes/second"`, `"terabytes/second"`, `"bits/second"`, `"kilobits/second"`, `"megabits/second"`, `"gigabits/second"`, `"terabits/second"`, `"count/second"`, `"none"`.
        """
        pulumi.set(__self__, "metric_name", metric_name)
        pulumi.set(__self__, "namespace", namespace)
    ...
    def max_target_capacity(self) -> Optional[builtins.str]:
        """
    ...
    def min_target_capacity(self) -> Optional[builtins.str]:
...
class ElastigroupScalingStrategy(dict):
    ...
    def __init__(__self__, *,
                 terminate_at_end_of_billing_hour: Optional[builtins.bool] = None,
                 termination_policy: Optional[builtins.str] = None):
        """
        :param builtins.bool terminate_at_end_of_billing_hour: Specify whether to terminate instances at the end of each billing hour.
        :param builtins.str termination_policy: Determines whether to terminate the newest instances when performing a scaling action. Valid values: `"default"`, `"newestInstance"`.
        """
    ...
    def terminate_at_end_of_billing_hour(self) -> Optional[builtins.bool]:
        """
    ...
    def termination_policy(self) -> Optional[builtins.str]:
        """
...
class ElastigroupScalingTargetPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 evaluation_periods: Optional[builtins.int] = None,
                 max_capacity_per_scale: Optional[builtins.str] = None,
                 period: Optional[builtins.int] = None,
                 predictive_mode: Optional[builtins.str] = None,
                 source: Optional[builtins.str] = None,
                 statistic: Optional[builtins.str] = None,
                 unit: Optional[builtins.str] = None):
        """
        :param builtins.str metric_name: String, the name of the metric, with or without spaces.
        :param builtins.str namespace: String, the namespace for the alarm's associated metric.
        :param builtins.str policy_name: String, the name of the policy.
        :param builtins.float target: The target number of instances to have in the group.
        :param builtins.int cooldown: Integer the amount of time, in seconds, after a scaling activity completes and before the next scaling activity can start. If this parameter is not specified, the default cooldown period for the group applies.
        ...
        :param builtins.int evaluation_periods: The number of periods over which data is compared to the specified threshold.
        :param builtins.str max_capacity_per_scale: String, restrict the maximal number of instances which can be added in each scale-up action.
               
               `scaling_target_policies` support predictive scaling:
        :param builtins.int period: The granularity, in seconds, of the returned datapoints. Period must be at least 60 seconds and must be a multiple of 60.
        :param builtins.str predictive_mode: Start a metric prediction process to determine the expected target metric value within the next two days. See [Predictive Autoscaling](https://api.spotinst.com/elastigroup-for-aws/concepts/scaling-concepts/predictive-autoscaling/) documentation for more info. Valid values: `FORECAST_AND_SCALE`, `FORECAST_ONLY`.
               
               Usage:
        :param builtins.str source: String, the source of the metric. Valid values: `"cloudWatch"`, `"spectrum"`.
        :param builtins.str statistic: String, the metric statistics to return. For information about specific statistics go to [Statistics](http://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/index.html?CHAP_TerminologyandKeyConcepts.html#Statistic) in the Amazon CloudWatch Developer Guide.
        :param builtins.str unit: String, tThe unit for the alarm's associated metric. Valid values: `"percent`, `"seconds"`, `"microseconds"`, `"milliseconds"`, `"bytes"`, `"kilobytes"`, `"megabytes"`, `"gigabytes"`, `"terabytes"`, `"bits"`, `"kilobits"`, `"megabits"`, `"gigabits"`, `"terabits"`, `"count"`, `"bytes/second"`, `"kilobytes/second"`, `"megabytes/second"`, `"gigabytes/second"`, `"terabytes/second"`, `"bits/second"`, `"kilobits/second"`, `"megabits/second"`, `"gigabits/second"`, `"terabits/second"`, `"count/second"`, `"none"`.
        """
        pulumi.set(__self__, "metric_name", metric_name)
        pulumi.set(__self__, "namespace", namespace)
        pulumi.set(__self__, "policy_name", policy_name)
    ...
    def max_capacity_per_scale(self) -> Optional[builtins.str]:
        """
    ...
    def predictive_mode(self) -> Optional[builtins.str]:
        """
...
class ElastigroupScalingTargetPolicyDimension(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str name: String, the dimension name.
        :param builtins.str value: String, the dimension value.
        """
        pulumi.set(__self__, "name", name)
        if value is not None:
            pulumi.set(__self__, "value", value)
...
class ElastigroupScalingUpPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool is_enabled: Specifies whether the scaling policy described in this block is enabled.
        :param builtins.str maximum: The maximal number of instances to have in the group.
        :param builtins.str min_target_capacity: . The number of the desired target (and minimum) capacity
        :param builtins.str minimum: The minimal number of instances to have in the group.
        :param builtins.str operator: The operator to use in order to determine if the scaling policy is applicable. Valid values: `"gt"`, `"gte"`, `"lt"`, `"lte"`.
        :param builtins.int period: The granularity, in seconds, of the returned datapoints. Period must be at least 60 seconds and must be a multiple of 60.
        :param builtins.str source: The source of the metric. Valid values: `"cloudWatch"`, `"spectrum"`.
...
class ElastigroupSignal(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the signal defined for the group. Valid Values: `"INSTANCE_READY"`, `"INSTANCE_READY_TO_SHUTDOWN"`
        :param builtins.int timeout: The signals defined timeout- default is 40 minutes (1800 seconds).
...
class ElastigroupStatefulDeallocation(dict):
    ...
    def __init__(__self__, *,
                 should_delete_images: Optional[builtins.bool] = None,
                 should_delete_network_interfaces: Optional[builtins.bool] = None,
                 should_delete_snapshots: Optional[builtins.bool] = None,
                 should_delete_volumes: Optional[builtins.bool] = None):
        """
        :param builtins.bool should_delete_images: For stateful groups: remove persistent images.
        :param builtins.bool should_delete_network_interfaces: For stateful groups: remove network interfaces.
        :param builtins.bool should_delete_snapshots: For stateful groups: remove snapshots.
               
               Usage:
        :param builtins.bool should_delete_volumes: For stateful groups: remove persistent volumes.
        """
    ...
    def should_delete_images(self) -> Optional[builtins.bool]:
        """
    ...
    def should_delete_network_interfaces(self) -> Optional[builtins.bool]:
        """
    ...
    def should_delete_snapshots(self) -> Optional[builtins.bool]:
        """
    ...
    def should_delete_volumes(self) -> Optional[builtins.bool]:
        """
...
class ElastigroupStatefulInstanceAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str stateful_instance_id: String, Stateful Instance ID on which the action should be performed.
        :param builtins.str type: String, Action type. Supported action types: `pause`, `resume`, `recycle`, `deallocate`.
...
class ElastigroupUpdatePolicy(dict):
    ...
    def __init__(__self__, *,
                 should_resume_stateful: builtins.bool,
        ...
        """
        :param builtins.bool should_resume_stateful: This will apply resuming action for Stateful instances in the Elastigroup upon scale up or capacity changes. Example usage will be for Elastigroups that will have scheduling rules to set a target capacity of 0 instances in the night and automatically restore the same state of the instances in the morning.
        :param builtins.bool should_roll: Sets the enablement of the roll option.
        :param builtins.bool auto_apply_tags: Enables updates to tags without rolling the group when set to `true`.
    ...
    def should_resume_stateful(self) -> builtins.bool:
        """
...
class ElastigroupUpdatePolicyRollConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 wait_for_roll_percentage: Optional[builtins.float] = None,
                 wait_for_roll_timeout: Optional[builtins.int] = None):
        """
        :param builtins.int batch_size_percentage: Sets the percentage of the instances to deploy in each batch.
        :param builtins.int grace_period: Sets the grace period for new instances to become healthy.
        :param builtins.str health_check_type: Sets the health check type to use. Valid values: `"EC2"`, `"ECS_CLUSTER_INSTANCE"`, `"ELB"`, `"HCS"`, `"TARGET_GROUP"`, `"NONE"`.
        :param 'ElastigroupUpdatePolicyRollConfigStrategyArgs' strategy: Strategy parameters
        :param builtins.float wait_for_roll_percentage: For use with `should_roll`. Sets minimum % of roll required to complete before continuing the plan. Required if `wait_for_roll_timeout` is set.
        :param builtins.int wait_for_roll_timeout: For use with `should_roll`. Sets how long to wait for the deployed % of a roll to exceed `wait_for_roll_percentage` before continuing the plan. Required if `wait_for_roll_percentage` is set.
        """
        pulumi.set(__self__, "batch_size_percentage", batch_size_percentage)
        if grace_period is not None:
            pulumi.set(__self__, "grace_period", grace_period)
    ...
    def wait_for_roll_percentage(self) -> Optional[builtins.float]:
        """
    ...
    def wait_for_roll_timeout(self) -> Optional[builtins.int]:
        """
...
class ElastigroupUpdatePolicyRollConfigStrategy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 should_drain_instances: Optional[builtins.bool] = None):
        """
        :param builtins.str action: Action to take. Valid values: `REPLACE_SERVER`, `RESTART_SERVER`.
        :param builtins.int batch_min_healthy_percentage: Indicates the threshold of minimum healthy instances in single batch. If the amount of healthy instances in single batch is under the threshold, the deployment will fail. Range `1` - `100`.
        :param 'ElastigroupUpdatePolicyRollConfigStrategyOnFailureArgs' on_failure: Set detach options to the deployment.
        :param builtins.bool should_drain_instances: Specify whether to drain incoming TCP connections before terminating a server.
        """
        pulumi.set(__self__, "action", action)
...
class ElastigroupUpdatePolicyRollConfigStrategyOnFailure(dict):
    ...
    def __init__(__self__, *,
                 ...
                 batch_num: Optional[builtins.int] = None,
                 draining_timeout: Optional[builtins.int] = None,
                 should_decrement_target_capacity: Optional[builtins.bool] = None,
                 should_handle_all_batches: Optional[builtins.bool] = None):
        """
        :param builtins.str action_type: Sets the action that will take place, Accepted values are: `DETACH_OLD`, `DETACH_NEW`.
        :param builtins.int draining_timeout: Indicates (in seconds) the timeout to wait until instance are detached.
        :param builtins.bool should_decrement_target_capacity: Decrementing the group target capacity after detaching the instances.
        :param builtins.bool should_handle_all_batches: Indicator if the action should apply to all batches of the deployment or only the latest batch.
        """
        pulumi.set(__self__, "action_type", action_type)
    ...
    def batch_num(self) -> Optional[builtins.int]:
    ...
    def should_decrement_target_capacity(self) -> Optional[builtins.bool]:
        """
    ...
    def should_handle_all_batches(self) -> Optional[builtins.bool]:
        """
...
class ManagedInstanceDelete(dict):
    ...
    def __init__(__self__, *,
                 ami_backup_should_delete_images: Optional[builtins.bool] = None,
                 deallocation_config_should_delete_images: Optional[builtins.bool] = None,
                 should_delete_network_interfaces: Optional[builtins.bool] = None,
                 should_delete_snapshots: Optional[builtins.bool] = None,
                 should_delete_volumes: Optional[builtins.bool] = None,
                 should_terminate_instance: Optional[builtins.bool] = None):
    ...
    def ami_backup_should_delete_images(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "ami_backup_should_delete_images")

    @property
    @pulumi.getter(name="deallocationConfigShouldDeleteImages")
    def deallocation_config_should_delete_images(self) -> Optional[builtins.bool]:
    ...
    def should_terminate_instance(self) -> Optional[builtins.bool]:
...
class MrScalarApplication(dict):
    def __init__(__self__, *,
                 ...
                 version: Optional[builtins.str] = None):
        """
        :param builtins.str name: The MrScaler name.
        :param Sequence[builtins.str] args: Arguments for EMR to pass to the application.
        :param builtins.str version: T he version of the application.
        """
        pulumi.set(__self__, "name", name)
        if args is not None:
...
class MrScalarCoreScalingDownPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str policy_name: The name of the policy.
        :param builtins.str action_type: The type of action to perform. Allowed values are : 'adjustment', 'setMinTarget', 'setMaxTarget', 'updateCapacity', 'percentageAdjustment'
        :param builtins.str adjustment: The number of instances to add/remove to/from the target capacity when scale is needed.
        :param builtins.int cooldown: The amount of time, in seconds, after a scaling activity completes and before the next scaling activity can start.
        :param Mapping[str, builtins.str] dimensions: A mapping of dimensions describing qualities of the metric.
        :param builtins.str max_target_capacity: Max target capacity for scale down.
        :param builtins.str maximum: The maximum to set when scale is needed.
        :param builtins.str min_target_capacity: Min target capacity for scale up.
        :param builtins.str minimum: The minimum to set when scale is needed.
        :param builtins.str target: The number of instances to set when scale is needed.
        """
        pulumi.set(__self__, "metric_name", metric_name)
        pulumi.set(__self__, "namespace", namespace)
        pulumi.set(__self__, "policy_name", policy_name)
...
class MrScalarInstanceWeight(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str instance_type: The type of the instance.
        :param builtins.int weighted_capacity: The weight given to the associated instance type.
        """
        pulumi.set(__self__, "instance_type", instance_type)
...
class MrScalarProvisioningTimeout(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int timeout: The amount of time (minutes) after which the cluster is automatically terminated if it's still in provisioning status. Minimum: '15'.
        :param builtins.str timeout_action: The action to take if the timeout is exceeded. Valid values: `terminate`, `terminateAndRetry`.
        """
        pulumi.set(__self__, "timeout", timeout)
...
class MrScalarScheduledTask(dict):
    ...
    def __init__(__self__, *,
                 ...
                 task_type: builtins.str,
                 desired_capacity: Optional[builtins.str] = None,
                 is_enabled: Optional[builtins.bool] = None,
                 max_capacity: Optional[builtins.str] = None,
                 min_capacity: Optional[builtins.str] = None):
        """
        :param builtins.str cron: A cron expression representing the schedule for the task.
        :param builtins.str instance_group_type: Select the EMR instance groups to execute the scheduled task on. Valid values: `task`.
        :param builtins.str task_type: The type of task to be scheduled. Valid values: `setCapacity`.
        :param builtins.str desired_capacity: New desired capacity for the elastigroup.
        :param builtins.bool is_enabled: Enable/Disable the specified scheduling task.
        :param builtins.str max_capacity: New max capacity for the elastigroup.
        :param builtins.str min_capacity: New min capacity for the elastigroup.
        """
    ...
    def desired_capacity(self) -> Optional[builtins.str]:
        """
...
class MrScalarTerminationPolicyStatement(dict):
    ...
    def __init__(__self__, *,
                 ...
                 unit: Optional[builtins.str] = None):
        """
        :param builtins.str metric_name: The name of the metric in CloudWatch which the statement will be based on.
        :param builtins.str namespace: Must contain the value: `AWS/ElasticMapReduce`.
        :param builtins.float threshold: The value that the specified statistic is compared to.
        :param builtins.int evaluation_periods: The number of periods over which data is compared to the specified threshold.
        :param builtins.str operator: The operator to use in order to determine if the policy is applicable. Valid values: `gt` | `gte` | `lt` | `lte`
        :param builtins.int period: The time window in seconds over which the statistic is applied.
        :param builtins.str statistic: The aggregation method of the given metric. Valid Values: `average` | `sum` | `sampleCount` | `maximum` | `minimum`
        :param builtins.str unit: The unit for a given metric. Valid Values: `seconds` | `microseconds` | `milliseconds` | `bytes` | `kilobytes` | `megabytes` | `gigabytes` | `terabytes` | `bits` | `kilobits` | `megabits` | `gigabits` | `terabits` | `percent` | `count` | `bytes/second` | `kilobytes/second` | `megabytes/second` | `gigabytes/second` | `terabytes/second` | `bits/second` | `kilobits/second` | `megabits/second` | `gigabits/second` | `terabits/second` | `count/second` | `none`
        """
        pulumi.set(__self__, "metric_name", metric_name)
        pulumi.set(__self__, "namespace", namespace)
        pulumi.set(__self__, "threshold", threshold)
...
class OceanAttachLoadBalancer(dict):
    def __init__(__self__, *,
                 ...
                 name: Optional[builtins.str] = None):
        """
        :param builtins.str type: Type of load balancer to use.
        :param builtins.str arn: If type is "TARGET_GROUP" then an ARN is required. Otherwise is not allowed.
        :param builtins.str name: If type is "CLASSIC" then a name is required. Otherwise is not allowed.
        """
        pulumi.set(__self__, "type", type)
        if arn is not None:
            pulumi.set(__self__, "arn", arn)
...
class OceanAutoscaler(dict):
    ...
    def __init__(__self__, *,
                 ...
                 extended_resource_definitions: Optional[Sequence[builtins.str]] = None,
                 resource_limits: Optional['outputs.OceanAutoscalerResourceLimits'] = None):
        """
        :param builtins.int auto_headroom_percentage: Set the auto headroom percentage (a number in the range [0, 200]) which controls the percentage of headroom from the cluster. Relevant only when `autoscale_is_auto_config` toggled on.
        :param builtins.int autoscale_cooldown: Cooldown period between scaling actions.
        ...
        :param builtins.bool autoscale_is_auto_config: Automatically configure and optimize headroom resources.
        :param builtins.bool autoscale_is_enabled: Enable the Ocean Kubernetes Auto Scaler.
        ...
        :param Sequence[builtins.str] extended_resource_definitions: List of Ocean extended resource definitions to use in this cluster.
    ...
    def extended_resource_definitions(self) -> Optional[Sequence[builtins.str]]:
        """
...
class OceanAutoscalerAutoscaleHeadroom(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int gpu_per_unit: Optionally configure the number of GPUs to allocate the headroom.
...
class OceanBlockDeviceMappingEbs(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int iops: Must be greater than or equal to 0.
...
class OceanBlockDeviceMappingEbsDynamicIops(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int base_size: Initial size for IOPS.
        :param builtins.int size_per_resource_unit: Additional size per resource unit (in IOPS). (Example: `baseSize=50`, `sizePerResourceUnit=20`, and an instance with 2 CPU is launched; its IOPS size will be: 90).
        """
        pulumi.set(__self__, "base_size", base_size)
        pulumi.set(__self__, "resource", resource)
        pulumi.set(__self__, "size_per_resource_unit", size_per_resource_unit)
...
class OceanInstanceStorePolicy(dict):
    ...
    def __init__(__self__, *,
                 instance_store_policy_type: Optional[builtins.str] = None):
        """
        :param builtins.str instance_store_policy_type: Value: `"RAID0"` The method for using the instance store volumes (must also be defined in the userData).
        """
    ...
    def instance_store_policy_type(self) -> Optional[builtins.str]:
        """
...
class OceanLaunchSpecAutoscaleDown(dict):
    ...
    def __init__(__self__, *,
                 max_scale_down_percentage: Optional[builtins.float] = None):
        """
        :param builtins.float max_scale_down_percentage: The maximum percentage allowed to scale down in a single scaling action on the nodes running in a specific VNG. Allowed only if maxScaleDownPercentage is set to null at the cluster level. Number between [0.1-100].
        """
        if max_scale_down_percentage is not None:
            pulumi.set(__self__, "max_scale_down_percentage", max_scale_down_percentage)
...
class OceanLaunchSpecCreateOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int initial_nodes: When set to an integer greater than 0, a corresponding amount of nodes will be launched from the created Virtual Node Group. The parameter is recommended in case the use_as_template_only (in aws.Ocean resource) is set to true during Ocean resource creation.
        """
...
class OceanLaunchSpecDeleteOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 delete_nodes: Optional[builtins.bool] = None):
        """
        :param builtins.bool force_delete: When set to `true`, delete even if it is the last Virtual Node Group (also, the default Virtual Node Group must be configured with `useAsTemlateOnly = true`). Should be set at creation or update, but will be used only at deletion.
        :param builtins.bool delete_nodes: When set to "true", all instances belonging to the deleted launch specification will be drained, detached, and terminated.
        """
    ...
    def delete_nodes(self) -> Optional[builtins.bool]:
        """
...
class OceanLaunchSpecElasticIpPoolTagSelector(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tag_value: Optional[builtins.str] = None):
        """
        :param builtins.str tag_key: Elastic IP tag key. The Virtual Node Group will consider all Elastic IPs tagged with this tag as a part of the Elastic IP pool to use.
        :param builtins.str tag_value: Elastic IP tag value. Can be null.
        """
        pulumi.set(__self__, "tag_key", tag_key)
        if tag_value is not None:
            pulumi.set(__self__, "tag_value", tag_value)
...
class OceanLaunchSpecEphemeralStorage(dict):
    ...
    def ephemeral_storage_device_name(self) -> Optional[builtins.str]:
        """
        Specify an alternative device name from which ephemeral storage calculations should be derived. This parameter is used when the ephemeral storage should not utilize the root device. Provide the device name configured in the VNG's BDM or AMI's BDM that differs from the default root device.
        """
...
class OceanLaunchSpecInstanceTypesFilters(dict):
    ...
    def __init__(__self__, *,
                 ...
                 virtualization_types: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] categories: The filtered instance types will belong to one of the categories types from this list. Valid values: `Accelerated_computing`, `Compute_optimized`, `General_purpose`, `Memory_optimized`, `Storage_optimized`.
        :param Sequence[builtins.str] disk_types: The filtered instance types will have one of the disk type from this list. Valid values: `NVMe`, `EBS`, `SSD`, `HDD`.
        :param Sequence[builtins.str] exclude_families: Types belonging to a family from the ExcludeFamilies will not be available for scaling (asterisk wildcard is also supported). For example, C* will exclude instance types from these families: c5, c4, c4a, etc.
        :param builtins.bool exclude_metal: In case excludeMetal is set to true, metal types will not be available for scaling.
        :param Sequence[builtins.str] hypervisors: The filtered instance types will have a hypervisor type from this list. Valid values: `nitro`, `xen`.
        :param Sequence[builtins.str] include_families: Types belonging to a family from the IncludeFamilies will be available for scaling (asterisk wildcard is also supported). For example, C* will include instance types from these families: c5, c4, c4a, etc.
        :param builtins.str is_ena_supported: Ena is supported or not.
        :param builtins.int max_gpu: Maximum total number of GPUs.
        ...
        :param builtins.int min_network_performance: Minimum Bandwidth in Gib/s of network performance.
        :param builtins.int min_vcpu: Minimum number of vcpus available.
        :param Sequence[builtins.str] root_device_types: The filtered instance types will have a root device types from this list. Valid values: `ebs`, or `instance-store`.
        :param Sequence[builtins.str] virtualization_types: The filtered instance types will support at least one of the virtualization types from this list. Valid values: `hvm`, `paravirtual`.
        """
        if categories is not None:
            pulumi.set(__self__, "categories", categories)
        if disk_types is not None:
...
class OceanLaunchSpecResourceLimit(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_instance_count: Set a maximum number of instances per Virtual Node Group. Can be null. If set, value must be greater than or equal to 0.
        :param builtins.int min_instance_count: Set a minimum number of instances per Virtual Node Group. Can be null. If set, value must be greater than or equal to 0.
        """
...
class OceanLaunchSpecSchedulingShutdownHours(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_enabled: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] time_windows: The times that the shutdown hours will apply.
        :param builtins.bool is_enabled: Flag to enable or disable the shutdown hours mechanism. When `false`, the mechanism is deactivated, and the virtual node group remains in its current state.
        """
        pulumi.set(__self__, "time_windows", time_windows)
        if is_enabled is not None:
            pulumi.set(__self__, "is_enabled", is_enabled)
...
class OceanLaunchSpecStrategy(dict):
    ...
    def utilize_commitments(self) -> Optional[builtins.bool]:
        """
    ...
    def utilize_reserved_instances(self) -> Optional[builtins.bool]:
        """
...
class OceanLoadBalancer(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str arn: Required if type is set to `TARGET_GROUP`
        :param builtins.str name: Required if type is set to `CLASSIC`
        :param builtins.str type: Can be set to `CLASSIC` or `TARGET_GROUP`
        """
        if arn is not None:
            pulumi.set(__self__, "arn", arn)
        if name is not None:
...
class OceanResourceTagSpecification(dict):
    ...
    def __init__(__self__, *,
                 should_tag_volumes: Optional[builtins.bool] = None):
        """
        :param builtins.bool should_tag_volumes: Specify if Volume resources will be tagged with Virtual Node Group tags or Ocean tags.
        """
        if should_tag_volumes is not None:
            pulumi.set(__self__, "should_tag_volumes", should_tag_volumes)
...
class OceanScheduledTaskShutdownHours(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool is_enabled: Toggle the shutdown hours task. (Example: `true`).
        """
        pulumi.set(__self__, "time_windows", time_windows)
        if is_enabled is not None:
            pulumi.set(__self__, "is_enabled", is_enabled)
...
class OceanScheduledTaskTask(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str task_type: Valid values: `clusterRoll` `amiAutoUpdate`. Required for `cluster.scheduling.tasks`
...
class OceanScheduledTaskTaskParametersAmiAutoUpdate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 minor_version: Optional[builtins.bool] = None,
                 patch: Optional[builtins.bool] = None):
        """
        ...
        :param builtins.bool apply_roll: When the AMI is updated according to the configuration set, a cluster roll can be triggered
        :param builtins.bool minor_version: When set to 'true', the auto-update process will update the VNGs’ AMI with the AMI to match the Kubernetes control plane version. either "patch" or "minor_version" must be true.
        :param builtins.bool patch: When set to 'true', the auto-update process will update the VNGs’ images with the latest security patches. either "patch" or "minorVersion" must be true.
        """
    ...
    def minor_version(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def patch(self) -> Optional[builtins.bool]:
        """
...
class OceanUpdatePolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 conditioned_roll_params: Optional[Sequence[builtins.str]] = None,
        ...
        :param Sequence[builtins.str] conditioned_roll_params: A custom list of attributes will trigger the cluster roll operation (overrides the predefined list of parameters). Valid only when the `conditioned_roll` parameter is set to true. (Valid values: `"subnet_ids"`,`"whitelist"`,`"blacklist"`,`"user_data"`,`"image_id"`,`"security_groups"`,`"key_name"`,`"iam_instance_profile"`,`"associate_public_ip_address"`,`"load_balancers"`,`"instance_metadata_options"`,`"ebs_optimized"`,`"root_volume_size"`)
    ...
    def conditioned_roll_params(self) -> Optional[Sequence[builtins.str]]:
        """
...
class SuspensionSuspension(dict):
    def __init__(__self__, *,
                 name: builtins.str):
        """
        :param builtins.str name: The name of process to suspend. Valid values: `"AUTO_HEALING" , "OUT_OF_STRATEGY", "PREVENTIVE_REPLACEMENT", "REVERT_PREFERRED", or "SCHEDULING"`.
        """
        pulumi.set(__self__, "name", name)
