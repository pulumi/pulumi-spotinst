...
class BeanstalkDeploymentPreferences(dict):
    ...
    def __init__(__self__, *,
                 automatic_roll: Optional[_builtins.bool] = None,
        ...
        """
        :param _builtins.bool automatic_roll: Should roll perform automatically
        :param _builtins.int batch_size_percentage: Percent size of each batch
        :param _builtins.int grace_period: Amount of time to wait between batches
    ...
    def automatic_roll(self) -> Optional[_builtins.bool]:
        """
...
class BeanstalkDeploymentPreferencesStrategy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 should_drain_instances: Optional[_builtins.bool] = None):
        """
        :param _builtins.str action: Action to take
        :param _builtins.bool should_drain_instances: Bool value if to wait to drain instance
        """
    ...
    def should_drain_instances(self) -> Optional[_builtins.bool]:
        """
...
class BeanstalkManagedActionsPlatformUpdate(dict):
    ...
    def __init__(__self__, *,
                 perform_at: Optional[_builtins.str] = None,
                 time_window: Optional[_builtins.str] = None,
                 update_level: Optional[_builtins.str] = None):
        """
        :param _builtins.str perform_at: Actions to perform (options: timeWindow, never)
        :param _builtins.str time_window: Time Window for when action occurs ex. Mon:23:50-Tue:00:20
        :param _builtins.str update_level: Level to update
        """
    ...
    def perform_at(self) -> Optional[_builtins.str]:
        """
    ...
    def update_level(self) -> Optional[_builtins.str]:
        """
        Level to update
        """
...
class BeanstalkScheduledTask(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str task_type: The task type to run. Supported task types are: `"scale"`, `"backup_ami"`, `"roll"`, `"scaleUp"`, `"percentageScaleUp"`, `"scaleDown"`, `"percentageScaleDown"`, `"statefulUpdateCapacity"`.
        :param _builtins.str adjustment: The number of instances to add or remove.
        :param _builtins.str adjustment_percentage: The percentage of instances to add or remove.
               
               Usage:
        :param _builtins.str batch_size_percentage: The percentage size of each batch in the scheduled deployment roll.
        ...
        :param _builtins.str frequency: The recurrence frequency to run this task. Supported values are `"hourly"`, `"daily"`, `"weekly"` and `"continuous"`.
        :param _builtins.str grace_period: The period of time (seconds) to wait before checking a batch's health after it's deployment.
        ...
        :param _builtins.str scale_max_capacity: The maximum number of instances the group should have.
        :param _builtins.str scale_min_capacity: The minimum number of instances the group should have.
        :param _builtins.str scale_target_capacity: The desired number of instances the group should have.
        :param _builtins.str start_time: Set a start time for one time tasks.
...
class ElastigroupCpuOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int threads_per_core: The ability to define the number of threads per core in instances that allow this.
        """
...
class ElastigroupEbsBlockDevice(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool delete_on_termination: Whether the volume should be destroyed on instance termination.
        ...
        :param _builtins.bool encrypted: Enables [EBS encryption](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html) on the volume.
        :param _builtins.int iops: The amount of provisioned [IOPS](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-io-characteristics.html). This must be set with a `volume_type` of `"io1"`.
        :param _builtins.str kms_key_id: ID for a user managed CMK under which the EBS Volume is encrypted
        ...
        :param _builtins.str volume_type: The type of volume. Can be `"standard"`, `"gp2"`, `"gp3"`, `"io1"`, `"st1"` or `"sc1"`.
        """
...
class ElastigroupEbsBlockDeviceDynamicIops(dict):
    ...
    def __init__(__self__, *,
                 base_size: Optional[_builtins.int] = None,
                 resource: Optional[_builtins.str] = None,
                 size_per_resource_unit: Optional[_builtins.int] = None):
        """
        :param _builtins.int base_size: Initial size for IOPS.
        :param _builtins.str resource: Type of resource, valid values: `"CPU", "MEMORY"`.
        :param _builtins.int size_per_resource_unit: Additional size per resource unit (in IOPS).
    ...
    def base_size(self) -> Optional[_builtins.int]:
        """
    ...
    def size_per_resource_unit(self) -> Optional[_builtins.int]:
        """
...
class ElastigroupEbsBlockDeviceDynamicVolumeSize(dict):
    ...
    def __init__(__self__, *,
                 ...
                 size_per_resource_unit: Optional[_builtins.int] = None):
        """
        :param _builtins.int base_size: Initial size for volume.
        :param _builtins.str resource: Type of resource, valid values: `"CPU", "MEMORY"`.
        :param _builtins.int size_per_resource_unit: Additional size per resource unit (in GB).
        """
        if base_size is not None:
            pulumi.set(__self__, "base_size", base_size)
        if resource is not None:
...
class ElastigroupEphemeralBlockDevice(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str device_name: The name of the block device to mount on the instance.
        :param _builtins.str virtual_name: The [Instance Store Device Name](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/InstanceStorage.html#InstanceStoreDeviceNames)
               (e.g. `"ephemeral0"`).
...
class ElastigroupInstanceTypesWeight(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str instance_type: Name of instance type (String).
        :param _builtins.int weight: Weight per instance type (Integer).
        """
...
class ElastigroupIntegrationCodedeploy(dict):
    ...
    def __init__(__self__, *,
                 cleanup_on_failure: _builtins.bool,
                 deployment_groups: Sequence['outputs.ElastigroupIntegrationCodedeployDeploymentGroup'],
                 terminate_instance_on_failure: _builtins.bool):
        """
        :param _builtins.bool cleanup_on_failure: Cleanup automatically after a failed deploy.
        ...
        :param _builtins.bool terminate_instance_on_failure: Terminate the instance automatically after a failed deploy.
        """
    ...
    def cleanup_on_failure(self) -> _builtins.bool:
        """
...
class ElastigroupIntegrationCodedeployDeploymentGroup(dict):
    ...
    def __init__(__self__, *,
                 ...
                 deployment_group_name: _builtins.str):
        """
        :param _builtins.str application_name: The application name.
        :param _builtins.str deployment_group_name: The deployment group name.
    ...
    def deployment_group_name(self) -> _builtins.str:
        """
...
class ElastigroupIntegrationEcs(dict):
    ...
    def __init__(__self__, *,
                 ...
                 autoscale_is_enabled: Optional[_builtins.bool] = None,
                 autoscale_scale_down_non_service_tasks: Optional[_builtins.bool] = None,
                 batch: Optional['outputs.ElastigroupIntegrationEcsBatch'] = None):
        """
        :param _builtins.str cluster_name: The name of the EC2 Container Service cluster.
        ...
        :param _builtins.bool autoscale_scale_down_non_service_tasks: Determines whether to scale down non-service tasks.
    ...
    def autoscale_scale_down_non_service_tasks(self) -> Optional[_builtins.bool]:
        """
...
class ElastigroupIntegrationEcsBatch(dict):
    ...
    def __init__(__self__, *,
                 job_queue_names: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] job_queue_names: Array of strings.
    ...
    def job_queue_names(self) -> Sequence[_builtins.str]:
        """
        Array of strings.
...
class ElastigroupIntegrationKubernetes(dict):
    ...
    def __init__(__self__, *,
                 ...
                 integration_mode: Optional[_builtins.str] = None,
        ...
        :param Sequence['ElastigroupIntegrationKubernetesAutoscaleLabelArgs'] autoscale_labels: A key/value mapping of tags to assign to the resource.
               ...
               Usage:
        :param _builtins.str integration_mode: Valid values: `"saas"`, `"pod"`.
        :param _builtins.str token: Kubernetes Token
        """
    ...
    def api_server(self) -> Optional[_builtins.str]:
    ...
    def integration_mode(self) -> Optional[_builtins.str]:
        """
...
class ElastigroupIntegrationMesosphere(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="apiServer")
    def api_server(self) -> _builtins.str:
        return pulumi.get(self, "api_server")
...
class ElastigroupIntegrationNomad(dict):
    ...
    def __init__(__self__, *,
                 master_host: _builtins.str,
                 master_port: _builtins.int,
                 acl_token: Optional[_builtins.str] = None,
                 ...
                 autoscale_is_enabled: Optional[_builtins.bool] = None):
        """
        :param _builtins.str acl_token: Nomad ACL Token
    ...
    def acl_token(self) -> Optional[_builtins.str]:
        """
        Nomad ACL Token
        """
...
class ElastigroupIntegrationRancher(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str access_key: The access key of the Rancher API.
        :param _builtins.str secret_key: The secret key of the Rancher API.
        :param _builtins.str version: The Rancher version. Must be `"1"` or `"2"`. If this field is omitted, it’s assumed that the Rancher cluster is version 1. Note that Kubernetes is required when using Rancher version 2^.
               Usage:
        """
...
class ElastigroupIntegrationRoute53Domain(dict):
    ...
    def __init__(__self__, *,
                 ...
                 record_set_type: Optional[_builtins.str] = None,
                 spotinst_acct_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str hosted_zone_id: The id associated with a hosted zone.
        ...
        :param _builtins.str record_set_type: The type of the record set. Valid values: `"a"`, `"cname"`.
        :param _builtins.str spotinst_acct_id: The Spotinst account ID that is linked to the AWS account that holds the Route 53 Hosted Zone ID. The default is the user Spotinst account provided as a URL parameter.
        """
    ...
    def record_set_type(self) -> Optional[_builtins.str]:
        """
    ...
    def spotinst_acct_id(self) -> Optional[_builtins.str]:
        """
...
class ElastigroupIntegrationRoute53DomainRecordSet(dict):
    ...
    def __init__(__self__, *,
                 name: _builtins.str,
                 use_public_dns: Optional[_builtins.bool] = None,
                 use_public_ip: Optional[_builtins.bool] = None):
        """
        :param _builtins.str name: The group name.
        :param _builtins.bool use_public_dns: Designates whether the DNS address should be exposed to connections outside the VPC.
               
               Usage:
        :param _builtins.bool use_public_ip: Designates whether the IP address should be exposed to connections outside the VPC.
        """
    ...
    def use_public_dns(self) -> Optional[_builtins.bool]:
        """
...
class ElastigroupItf(dict):
    ...
    def __init__(__self__, *,
                 fixed_target_groups: _builtins.bool,
                 ...
                 weight_strategy: _builtins.str,
                 default_static_target_group: Optional['outputs.ElastigroupItfDefaultStaticTargetGroup'] = None,
                 migration_healthiness_threshold: Optional[_builtins.int] = None):
    ...
    def fixed_target_groups(self) -> _builtins.bool:
    ...
    def weight_strategy(self) -> _builtins.str:
    ...
    def migration_healthiness_threshold(self) -> Optional[_builtins.int]:
...
class ElastigroupItfLoadBalancerListenerRule(dict):
    ...
    def rule_arn(self) -> _builtins.str:
...
class ElastigroupItfTargetGroupConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 health_check_port: Optional[_builtins.str] = None,
...
class ElastigroupItfTargetGroupConfigMatcher(dict):
    ...
    def __init__(__self__, *,
                 grpc_code: Optional[_builtins.str] = None,
    ...
    def grpc_code(self) -> Optional[_builtins.str]:
...
class ElastigroupMetadataOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str http_tokens: The state of token usage for your instance metadata requests. Valid values: `optional` or `required`.
        :param _builtins.int http_put_response_hop_limit: The desired HTTP PUT response hop limit for instance metadata requests. The larger the number, the further instance metadata requests can travel. Valid values: Integers from `1` to `64`.
        :param _builtins.str instance_metadata_tags: Indicates whether access to instance tags from the instance metadata is enabled or disabled. Can’t be null.
        """
...
class ElastigroupMultipleMetricsExpression(dict):
    def __init__(__self__, *,
                 ...
                 name: _builtins.str):
        """
        :param _builtins.str expression: An expression consisting of the metric names listed in the 'metrics' array.
        :param _builtins.str name: The group name.
        """
...
class ElastigroupMultipleMetricsMetric(dict):
    ...
    def __init__(__self__, *,
                 ...
                 extended_statistic: Optional[_builtins.str] = None,
                 statistic: Optional[_builtins.str] = None,
                 unit: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: The group name.
        :param _builtins.str extended_statistic: Percentile statistic. Valid values: `"p0.1"` - `"p100"`.
        """
    ...
    def extended_statistic(self) -> Optional[_builtins.str]:
        """
...
class ElastigroupNetworkInterface(dict):
    ...
    def __init__(__self__, *,
                 ...
                 associate_ipv6_address: Optional[_builtins.bool] = None,
                 ...
                 secondary_private_ip_address_count: Optional[_builtins.str] = None):
        """
        :param _builtins.str device_index: The index of the device on the instance for the network interface attachment.
        :param _builtins.bool associate_ipv6_address: Indicates whether to assign IPV6 addresses to your instance. Requires a subnet with IPV6 CIDR block ranges.
               
               Usage:
        :param _builtins.bool associate_public_ip_address: Indicates whether to assign a public IP address to an instance you launch in a VPC. The public IP address can only be assigned to a network interface for eth0, and can only be assigned to a new network interface, not an existing one.
        ...
        :param _builtins.str secondary_private_ip_address_count: The number of secondary private IP addresses.
        """
    ...
    def associate_ipv6_address(self) -> Optional[_builtins.bool]:
        """
    ...
    def secondary_private_ip_address_count(self) -> Optional[_builtins.str]:
        """
...
class ElastigroupResourceRequirement(dict):
    ...
    def __init__(__self__, *,
                 required_memory_maximum: _builtins.int,
                 required_memory_minimum: _builtins.int,
                 required_vcpu_maximum: _builtins.int,
                 required_vcpu_minimum: _builtins.int,
                 excluded_instance_families: Optional[Sequence[_builtins.str]] = None,
                 excluded_instance_generations: Optional[Sequence[_builtins.str]] = None,
                 excluded_instance_types: Optional[Sequence[_builtins.str]] = None,
                 required_gpu_maximum: Optional[_builtins.int] = None,
                 required_gpu_minimum: Optional[_builtins.int] = None):
        """
        :param _builtins.int required_memory_maximum: Required maximum instance memory (<=512)
        :param _builtins.int required_memory_minimum: Required minimum instance memory (>=1)
        :param _builtins.int required_vcpu_maximum: Required maximum instance vCPU (<=64)
        :param _builtins.int required_vcpu_minimum: Required minimum instance vCPU (>=1)
        :param Sequence[_builtins.str] excluded_instance_families: Instance families to exclude
        :param Sequence[_builtins.str] excluded_instance_generations: Instance generations to exclude
        :param Sequence[_builtins.str] excluded_instance_types: Instance types to exclude
        :param _builtins.int required_gpu_maximum: Required maximum instance GPU (<=16)
        :param _builtins.int required_gpu_minimum: Required minimum instance GPU (>=1)
        """
    ...
    def required_memory_maximum(self) -> _builtins.int:
        """
    ...
    def required_memory_minimum(self) -> _builtins.int:
        """
    ...
    def required_vcpu_maximum(self) -> _builtins.int:
        """
    ...
    def required_vcpu_minimum(self) -> _builtins.int:
        """
    ...
    def excluded_instance_families(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def excluded_instance_generations(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def required_gpu_maximum(self) -> Optional[_builtins.int]:
        """
    ...
    def required_gpu_minimum(self) -> Optional[_builtins.int]:
        """
...
class ElastigroupResourceTagSpecification(dict):
    ...
    def __init__(__self__, *,
                 should_tag_amis: Optional[_builtins.bool] = None,
                 should_tag_enis: Optional[_builtins.bool] = None,
                 should_tag_snapshots: Optional[_builtins.bool] = None,
                 should_tag_volumes: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool should_tag_amis: Tag specification for AMI resources.
        :param _builtins.bool should_tag_enis: Tag specification for ENI resources.
        :param _builtins.bool should_tag_snapshots: Tag specification for Snapshot resources.
        :param _builtins.bool should_tag_volumes: Tag specification for Volume resources.
        """
    ...
    def should_tag_amis(self) -> Optional[_builtins.bool]:
        """
    ...
    def should_tag_enis(self) -> Optional[_builtins.bool]:
        """
    ...
    def should_tag_snapshots(self) -> Optional[_builtins.bool]:
        """
    ...
    def should_tag_volumes(self) -> Optional[_builtins.bool]:
        """
...
class ElastigroupRevertToSpot(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str perform_at: In the event of a fallback to On-Demand instances, select the time period to revert back to Spot. Supported Arguments – always (default), timeWindow, never. For timeWindow or never to be valid the group must have availabilityOriented OR persistence defined.
        :param Sequence[_builtins.str] time_windows: Specify a list of time windows for to execute revertToSpot strategy. Time window format: `ddd:hh:mm-ddd:hh:mm`. Example: `Mon:03:00-Wed:02:30`
        """
        pulumi.set(__self__, "perform_at", perform_at)
...
class ElastigroupScalingDownPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 evaluation_periods: Optional[_builtins.int] = None,
                 is_enabled: Optional[_builtins.bool] = None,
                 max_target_capacity: Optional[_builtins.str] = None,
                 maximum: Optional[_builtins.str] = None,
                 min_target_capacity: Optional[_builtins.str] = None,
                 ...
                 unit: Optional[_builtins.str] = None):
        """
        :param _builtins.str metric_name: The name of the metric, with or without spaces.
        :param _builtins.str namespace: The namespace for the alarm's associated metric.
        :param _builtins.str policy_name: The name of the policy.
        :param _builtins.str action_type: The type of action to perform for scaling. Valid values: `"adjustment"`, `"percentageAdjustment"`, `"setMaxTarget"`, `"setMinTarget"`, `"updateCapacity"`. If a `step_adjustment` object is defined, then it cannot be specified.
        :param _builtins.str adjustment: The number of instances to add/remove to/from the target capacity when scale is needed. Can be used as advanced expression for scaling of instances to add/remove to/from the target capacity when scale is needed. You can see more information here: Advanced expression. Example value: `"MAX(currCapacity / 5, value * 10)"`
        :param _builtins.int cooldown: The amount of time, in seconds, after a scaling activity completes and before the next scaling activity can start. If this parameter is not specified, the default cooldown period for the group applies.
        ...
        :param _builtins.int evaluation_periods: The number of periods over which data is compared to the specified threshold.
        :param _builtins.bool is_enabled: Specifies whether the scaling policy described in this block is enabled.
        :param _builtins.str max_target_capacity: . The number of the desired target (and maximum) capacity
        :param _builtins.str maximum: The maximal number of instances to have in the group.
        :param _builtins.str minimum: The minimal number of instances to have in the group.
        :param _builtins.str operator: The operator to use in order to determine if the scaling policy is applicable. Valid values: `"gt"`, `"gte"`, `"lt"`, `"lte"`.
        :param _builtins.int period: The granularity, in seconds, of the returned datapoints. Period must be at least 60 seconds and must be a multiple of 60.
        :param _builtins.str source: The source of the metric. Valid values: `"cloudWatch"`, `"spectrum"`.
        :param _builtins.str statistic: The metric statistics to return. For information about specific statistics go to [Statistics](http://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/index.html?CHAP_TerminologyandKeyConcepts.html#Statistic) in the Amazon CloudWatch Developer Guide.
        :param _builtins.str target: The target number of instances to have in the group.
        :param _builtins.float threshold: The value against which the specified statistic is compared. If a `step_adjustment` object is defined, then it cannot be specified.
        :param _builtins.str unit: The unit for the alarm's associated metric. Valid values: `"percent`, `"seconds"`, `"microseconds"`, `"milliseconds"`, `"bytes"`, `"kilobytes"`, `"megabytes"`, `"gigabytes"`, `"terabytes"`, `"bits"`, `"kilobits"`, `"megabits"`, `"gigabits"`, `"terabits"`, `"count"`, `"bytes/second"`, `"kilobytes/second"`, `"megabytes/second"`, `"gigabytes/second"`, `"terabytes/second"`, `"bits/second"`, `"kilobits/second"`, `"megabits/second"`, `"gigabits/second"`, `"terabits/second"`, `"count/second"`, `"none"`.
        """
        pulumi.set(__self__, "metric_name", metric_name)
        pulumi.set(__self__, "namespace", namespace)
    ...
    def max_target_capacity(self) -> Optional[_builtins.str]:
        """
    ...
    def min_target_capacity(self) -> Optional[_builtins.str]:
...
class ElastigroupScalingStrategy(dict):
    ...
    def __init__(__self__, *,
                 terminate_at_end_of_billing_hour: Optional[_builtins.bool] = None,
                 termination_policy: Optional[_builtins.str] = None):
        """
        :param _builtins.bool terminate_at_end_of_billing_hour: Specify whether to terminate instances at the end of each billing hour.
        :param _builtins.str termination_policy: Determines whether to terminate the newest instances when performing a scaling action. Valid values: `"default"`, `"newestInstance"`.
        """
    ...
    def terminate_at_end_of_billing_hour(self) -> Optional[_builtins.bool]:
        """
    ...
    def termination_policy(self) -> Optional[_builtins.str]:
        """
...
class ElastigroupScalingTargetPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 evaluation_periods: Optional[_builtins.int] = None,
                 max_capacity_per_scale: Optional[_builtins.str] = None,
                 period: Optional[_builtins.int] = None,
                 predictive_mode: Optional[_builtins.str] = None,
                 source: Optional[_builtins.str] = None,
                 statistic: Optional[_builtins.str] = None,
                 unit: Optional[_builtins.str] = None):
        """
        :param _builtins.str metric_name: String, the name of the metric, with or without spaces.
        :param _builtins.str namespace: String, the namespace for the alarm's associated metric.
        :param _builtins.str policy_name: String, the name of the policy.
        :param _builtins.float target: The target number of instances to have in the group.
        :param _builtins.int cooldown: Integer the amount of time, in seconds, after a scaling activity completes and before the next scaling activity can start. If this parameter is not specified, the default cooldown period for the group applies.
        ...
        :param _builtins.int evaluation_periods: The number of periods over which data is compared to the specified threshold.
        :param _builtins.str max_capacity_per_scale: String, restrict the maximal number of instances which can be added in each scale-up action.
               
               `scaling_target_policies` support predictive scaling:
        :param _builtins.int period: The granularity, in seconds, of the returned datapoints. Period must be at least 60 seconds and must be a multiple of 60.
        :param _builtins.str predictive_mode: Start a metric prediction process to determine the expected target metric value within the next two days. See [Predictive Autoscaling](https://api.spotinst.com/elastigroup-for-aws/concepts/scaling-concepts/predictive-autoscaling/) documentation for more info. Valid values: `FORECAST_AND_SCALE`, `FORECAST_ONLY`.
               
               Usage:
        :param _builtins.str source: String, the source of the metric. Valid values: `"cloudWatch"`, `"spectrum"`.
        :param _builtins.str statistic: String, the metric statistics to return. For information about specific statistics go to [Statistics](http://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/index.html?CHAP_TerminologyandKeyConcepts.html#Statistic) in the Amazon CloudWatch Developer Guide.
        :param _builtins.str unit: String, tThe unit for the alarm's associated metric. Valid values: `"percent`, `"seconds"`, `"microseconds"`, `"milliseconds"`, `"bytes"`, `"kilobytes"`, `"megabytes"`, `"gigabytes"`, `"terabytes"`, `"bits"`, `"kilobits"`, `"megabits"`, `"gigabits"`, `"terabits"`, `"count"`, `"bytes/second"`, `"kilobytes/second"`, `"megabytes/second"`, `"gigabytes/second"`, `"terabytes/second"`, `"bits/second"`, `"kilobits/second"`, `"megabits/second"`, `"gigabits/second"`, `"terabits/second"`, `"count/second"`, `"none"`.
        """
        pulumi.set(__self__, "metric_name", metric_name)
        pulumi.set(__self__, "namespace", namespace)
        pulumi.set(__self__, "policy_name", policy_name)
    ...
    def max_capacity_per_scale(self) -> Optional[_builtins.str]:
        """
    ...
    def predictive_mode(self) -> Optional[_builtins.str]:
        """
...
class ElastigroupScalingTargetPolicyDimension(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: String, the dimension name.
        :param _builtins.str value: String, the dimension value.
        """
        pulumi.set(__self__, "name", name)
        if value is not None:
            pulumi.set(__self__, "value", value)
...
class ElastigroupScalingUpPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool is_enabled: Specifies whether the scaling policy described in this block is enabled.
        :param _builtins.str maximum: The maximal number of instances to have in the group.
        :param _builtins.str min_target_capacity: . The number of the desired target (and minimum) capacity
        :param _builtins.str minimum: The minimal number of instances to have in the group.
        :param _builtins.str operator: The operator to use in order to determine if the scaling policy is applicable. Valid values: `"gt"`, `"gte"`, `"lt"`, `"lte"`.
        :param _builtins.int period: The granularity, in seconds, of the returned datapoints. Period must be at least 60 seconds and must be a multiple of 60.
        :param _builtins.str source: The source of the metric. Valid values: `"cloudWatch"`, `"spectrum"`.
...
class ElastigroupSignal(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name of the signal defined for the group. Valid Values: `"INSTANCE_READY"`, `"INSTANCE_READY_TO_SHUTDOWN"`
        :param _builtins.int timeout: The signals defined timeout- default is 40 minutes (1800 seconds).
...
class ElastigroupStatefulDeallocation(dict):
    ...
    def __init__(__self__, *,
                 should_delete_images: Optional[_builtins.bool] = None,
                 should_delete_network_interfaces: Optional[_builtins.bool] = None,
                 should_delete_snapshots: Optional[_builtins.bool] = None,
                 should_delete_volumes: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool should_delete_images: For stateful groups: remove persistent images.
        :param _builtins.bool should_delete_network_interfaces: For stateful groups: remove network interfaces.
        :param _builtins.bool should_delete_snapshots: For stateful groups: remove snapshots.
               
               Usage:
        :param _builtins.bool should_delete_volumes: For stateful groups: remove persistent volumes.
        """
    ...
    def should_delete_images(self) -> Optional[_builtins.bool]:
        """
    ...
    def should_delete_network_interfaces(self) -> Optional[_builtins.bool]:
        """
    ...
    def should_delete_snapshots(self) -> Optional[_builtins.bool]:
        """
    ...
    def should_delete_volumes(self) -> Optional[_builtins.bool]:
        """
...
class ElastigroupStatefulInstanceAction(dict):
    ...
    def __init__(__self__, *,
                 stateful_instance_id: _builtins.str,
                 type: _builtins.str):
        """
        :param _builtins.str stateful_instance_id: String, Stateful Instance ID on which the action should be performed.
        :param _builtins.str type: String, Action type. Supported action types: `pause`, `resume`, `recycle`, `deallocate`.
    ...
    def stateful_instance_id(self) -> _builtins.str:
        """
...
class ElastigroupUpdatePolicy(dict):
    ...
    def __init__(__self__, *,
                 should_resume_stateful: _builtins.bool,
        ...
        """
        :param _builtins.bool should_resume_stateful: This will apply resuming action for Stateful instances in the Elastigroup upon scale up or capacity changes. Example usage will be for Elastigroups that will have scheduling rules to set a target capacity of 0 instances in the night and automatically restore the same state of the instances in the morning.
        :param _builtins.bool should_roll: Sets the enablement of the roll option.
        :param _builtins.bool auto_apply_tags: Enables updates to tags without rolling the group when set to `true`.
    ...
    def should_resume_stateful(self) -> _builtins.bool:
        """
...
class ElastigroupUpdatePolicyRollConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 wait_for_roll_percentage: Optional[_builtins.float] = None,
                 wait_for_roll_timeout: Optional[_builtins.int] = None):
        """
        :param _builtins.int batch_size_percentage: Sets the percentage of the instances to deploy in each batch.
        :param _builtins.int grace_period: Sets the grace period for new instances to become healthy.
        :param _builtins.str health_check_type: Sets the health check type to use. Valid values: `"EC2"`, `"ECS_CLUSTER_INSTANCE"`, `"ELB"`, `"HCS"`, `"TARGET_GROUP"`, `"NONE"`.
        :param 'ElastigroupUpdatePolicyRollConfigStrategyArgs' strategy: Strategy parameters
        :param _builtins.float wait_for_roll_percentage: For use with `should_roll`. Sets minimum % of roll required to complete before continuing the plan. Required if `wait_for_roll_timeout` is set.
        :param _builtins.int wait_for_roll_timeout: For use with `should_roll`. Sets how long to wait for the deployed % of a roll to exceed `wait_for_roll_percentage` before continuing the plan. Required if `wait_for_roll_percentage` is set.
        """
        pulumi.set(__self__, "batch_size_percentage", batch_size_percentage)
        if grace_period is not None:
            pulumi.set(__self__, "grace_period", grace_period)
    ...
    def wait_for_roll_percentage(self) -> Optional[_builtins.float]:
        """
    ...
    def wait_for_roll_timeout(self) -> Optional[_builtins.int]:
        """
...
class ElastigroupUpdatePolicyRollConfigStrategy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 should_drain_instances: Optional[_builtins.bool] = None):
        """
        :param _builtins.str action: Action to take. Valid values: `REPLACE_SERVER`, `RESTART_SERVER`.
        :param _builtins.int batch_min_healthy_percentage: Indicates the threshold of minimum healthy instances in single batch. If the amount of healthy instances in single batch is under the threshold, the deployment will fail. Range `1` - `100`.
        :param 'ElastigroupUpdatePolicyRollConfigStrategyOnFailureArgs' on_failure: Set detach options to the deployment.
        :param _builtins.bool should_drain_instances: Specify whether to drain incoming TCP connections before terminating a server.
        """
        pulumi.set(__self__, "action", action)
...
class ElastigroupUpdatePolicyRollConfigStrategyOnFailure(dict):
    ...
    def __init__(__self__, *,
                 ...
                 batch_num: Optional[_builtins.int] = None,
                 draining_timeout: Optional[_builtins.int] = None,
                 should_decrement_target_capacity: Optional[_builtins.bool] = None,
                 should_handle_all_batches: Optional[_builtins.bool] = None):
        """
        :param _builtins.str action_type: Sets the action that will take place, Accepted values are: `DETACH_OLD`, `DETACH_NEW`.
        :param _builtins.int draining_timeout: Indicates (in seconds) the timeout to wait until instance are detached.
        :param _builtins.bool should_decrement_target_capacity: Decrementing the group target capacity after detaching the instances.
        :param _builtins.bool should_handle_all_batches: Indicator if the action should apply to all batches of the deployment or only the latest batch.
        """
        pulumi.set(__self__, "action_type", action_type)
    ...
    def batch_num(self) -> Optional[_builtins.int]:
    ...
    def should_decrement_target_capacity(self) -> Optional[_builtins.bool]:
        """
    ...
    def should_handle_all_batches(self) -> Optional[_builtins.bool]:
        """
...
class ManagedInstanceDelete(dict):
    ...
    def __init__(__self__, *,
                 ami_backup_should_delete_images: Optional[_builtins.bool] = None,
                 deallocation_config_should_delete_images: Optional[_builtins.bool] = None,
                 should_delete_network_interfaces: Optional[_builtins.bool] = None,
                 should_delete_snapshots: Optional[_builtins.bool] = None,
                 should_delete_volumes: Optional[_builtins.bool] = None,
                 should_terminate_instance: Optional[_builtins.bool] = None):
    ...
    def ami_backup_should_delete_images(self) -> Optional[_builtins.bool]:
        return pulumi.get(self, "ami_backup_should_delete_images")

    @_builtins.property
    @pulumi.getter(name="deallocationConfigShouldDeleteImages")
    def deallocation_config_should_delete_images(self) -> Optional[_builtins.bool]:
    ...
    def should_terminate_instance(self) -> Optional[_builtins.bool]:
...
class MrScalarApplication(dict):
    def __init__(__self__, *,
                 ...
                 version: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: The MrScaler name.
        :param Sequence[_builtins.str] args: Arguments for EMR to pass to the application.
        :param _builtins.str version: T he version of the application.
        """
        pulumi.set(__self__, "name", name)
        if args is not None:
...
class MrScalarCoreScalingDownPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str policy_name: The name of the policy.
        :param _builtins.str action_type: The type of action to perform. Allowed values are : 'adjustment', 'setMinTarget', 'setMaxTarget', 'updateCapacity', 'percentageAdjustment'
        :param _builtins.str adjustment: The number of instances to add/remove to/from the target capacity when scale is needed.
        :param _builtins.int cooldown: The amount of time, in seconds, after a scaling activity completes and before the next scaling activity can start.
        :param Mapping[str, _builtins.str] dimensions: A mapping of dimensions describing qualities of the metric.
        :param _builtins.str max_target_capacity: Max target capacity for scale down.
        :param _builtins.str maximum: The maximum to set when scale is needed.
        :param _builtins.str min_target_capacity: Min target capacity for scale up.
        :param _builtins.str minimum: The minimum to set when scale is needed.
        :param _builtins.str target: The number of instances to set when scale is needed.
        """
        pulumi.set(__self__, "metric_name", metric_name)
        pulumi.set(__self__, "namespace", namespace)
        pulumi.set(__self__, "policy_name", policy_name)
...
class MrScalarInstanceWeight(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int weighted_capacity: The weight given to the associated instance type.
        """
        pulumi.set(__self__, "instance_type", instance_type)
...
class MrScalarProvisioningTimeout(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int timeout: The amount of time (minutes) after which the cluster is automatically terminated if it's still in provisioning status. Minimum: '15'.
        :param _builtins.str timeout_action: The action to take if the timeout is exceeded. Valid values: `terminate`, `terminateAndRetry`.
        """
        pulumi.set(__self__, "timeout", timeout)
...
class MrScalarScheduledTask(dict):
    ...
    def __init__(__self__, *,
                 cron: _builtins.str,
                 instance_group_type: _builtins.str,
                 task_type: _builtins.str,
                 desired_capacity: Optional[_builtins.str] = None,
                 is_enabled: Optional[_builtins.bool] = None,
                 max_capacity: Optional[_builtins.str] = None,
                 min_capacity: Optional[_builtins.str] = None):
        """
        :param _builtins.str cron: A cron expression representing the schedule for the task.
        :param _builtins.str instance_group_type: Select the EMR instance groups to execute the scheduled task on. Valid values: `task`.
        :param _builtins.str task_type: The type of task to be scheduled. Valid values: `setCapacity`.
        :param _builtins.str desired_capacity: New desired capacity for the elastigroup.
        :param _builtins.bool is_enabled: Enable/Disable the specified scheduling task.
        :param _builtins.str max_capacity: New max capacity for the elastigroup.
        :param _builtins.str min_capacity: New min capacity for the elastigroup.
        """
    ...
    def instance_group_type(self) -> _builtins.str:
        """
...
class MrScalarTerminationPolicyStatement(dict):
    ...
    def __init__(__self__, *,
                 ...
                 unit: Optional[_builtins.str] = None):
        """
        :param _builtins.str metric_name: The name of the metric in CloudWatch which the statement will be based on.
        :param _builtins.str namespace: Must contain the value: `AWS/ElasticMapReduce`.
        :param _builtins.float threshold: The value that the specified statistic is compared to.
        :param _builtins.int evaluation_periods: The number of periods over which data is compared to the specified threshold.
        :param _builtins.str operator: The operator to use in order to determine if the policy is applicable. Valid values: `gt` | `gte` | `lt` | `lte`
        :param _builtins.int period: The time window in seconds over which the statistic is applied.
        :param _builtins.str statistic: The aggregation method of the given metric. Valid Values: `average` | `sum` | `sampleCount` | `maximum` | `minimum`
        :param _builtins.str unit: The unit for a given metric. Valid Values: `seconds` | `microseconds` | `milliseconds` | `bytes` | `kilobytes` | `megabytes` | `gigabytes` | `terabytes` | `bits` | `kilobits` | `megabits` | `gigabits` | `terabits` | `percent` | `count` | `bytes/second` | `kilobytes/second` | `megabytes/second` | `gigabytes/second` | `terabytes/second` | `bits/second` | `kilobits/second` | `megabits/second` | `gigabits/second` | `terabits/second` | `count/second` | `none`
        """
        pulumi.set(__self__, "metric_name", metric_name)
        pulumi.set(__self__, "namespace", namespace)
        pulumi.set(__self__, "threshold", threshold)
...
class OceanAttachLoadBalancer(dict):
    def __init__(__self__, *,
                 ...
                 name: Optional[_builtins.str] = None):
        """
        :param _builtins.str type: Type of load balancer to use.
        :param _builtins.str arn: If type is "TARGET_GROUP" then an ARN is required. Otherwise is not allowed.
        :param _builtins.str name: If type is "CLASSIC" then a name is required. Otherwise is not allowed.
        """
        pulumi.set(__self__, "type", type)
        if arn is not None:
            pulumi.set(__self__, "arn", arn)
...
class OceanAutoscaler(dict):
    ...
    def __init__(__self__, *,
                 ...
                 extended_resource_definitions: Optional[Sequence[_builtins.str]] = None,
                 resource_limits: Optional['outputs.OceanAutoscalerResourceLimits'] = None):
        """
        :param _builtins.int auto_headroom_percentage: Set the auto headroom percentage (a number in the range [0, 200]) which controls the percentage of headroom from the cluster. Relevant only when `autoscale_is_auto_config` toggled on.
        :param _builtins.int autoscale_cooldown: Cooldown period between scaling actions.
        ...
        :param _builtins.bool autoscale_is_auto_config: Automatically configure and optimize headroom resources.
        :param _builtins.bool autoscale_is_enabled: Enable the Ocean Kubernetes Auto Scaler.
        ...
        :param Sequence[_builtins.str] extended_resource_definitions: List of Ocean extended resource definitions to use in this cluster.
    ...
    def extended_resource_definitions(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class OceanAutoscalerAutoscaleHeadroom(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int gpu_per_unit: Optionally configure the number of GPUs to allocate the headroom.
...
class OceanBlockDeviceMappingEbs(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int iops: Must be greater than or equal to 0.
...
class OceanInstanceStorePolicy(dict):
    ...
    def __init__(__self__, *,
                 instance_store_policy_type: Optional[_builtins.str] = None):
        """
        :param _builtins.str instance_store_policy_type: Value: `"RAID0"` The method for using the instance store volumes (must also be defined in the userData).
        """
    ...
    def instance_store_policy_type(self) -> Optional[_builtins.str]:
        """
...
class OceanLaunchSpecCreateOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int initial_nodes: When set to an integer greater than 0, a corresponding amount of nodes will be launched from the created Virtual Node Group. The parameter is recommended in case the use_as_template_only (in aws.Ocean resource) is set to true during Ocean resource creation.
        """
...
class OceanLaunchSpecDeleteOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 delete_nodes: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool force_delete: When set to `true`, delete even if it is the last Virtual Node Group (also, the default Virtual Node Group must be configured with `useAsTemlateOnly = true`). Should be set at creation or update, but will be used only at deletion.
        :param _builtins.bool delete_nodes: When set to "true", all instances belonging to the deleted launch specification will be drained, detached, and terminated.
        """
    ...
    def delete_nodes(self) -> Optional[_builtins.bool]:
        """
...
class OceanLaunchSpecElasticIpPoolTagSelector(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tag_value: Optional[_builtins.str] = None):
        """
        :param _builtins.str tag_key: Elastic IP tag key. The Virtual Node Group will consider all Elastic IPs tagged with this tag as a part of the Elastic IP pool to use.
        :param _builtins.str tag_value: Elastic IP tag value. Can be null.
        """
        pulumi.set(__self__, "tag_key", tag_key)
        if tag_value is not None:
            pulumi.set(__self__, "tag_value", tag_value)
...
class OceanLaunchSpecEphemeralStorage(dict):
    ...
    def ephemeral_storage_device_name(self) -> Optional[_builtins.str]:
        """
        Specify an alternative device name from which ephemeral storage calculations should be derived. This parameter is used when the ephemeral storage should not utilize the root device. Provide the device name configured in the VNG's BDM or AMI's BDM that differs from the default root device.
        """
...
class OceanLaunchSpecInstanceTypesFilters(dict):
    ...
    def __init__(__self__, *,
                 ...
                 virtualization_types: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] categories: The filtered instance types will belong to one of the categories types from this list. Valid values: `Accelerated_computing`, `Compute_optimized`, `General_purpose`, `Memory_optimized`, `Storage_optimized`.
        :param Sequence[_builtins.str] disk_types: The filtered instance types will have one of the disk type from this list. Valid values: `NVMe`, `EBS`, `SSD`, `HDD`.
        :param Sequence[_builtins.str] exclude_families: Types belonging to a family from the ExcludeFamilies will not be available for scaling (asterisk wildcard is also supported). For example, C* will exclude instance types from these families: c5, c4, c4a, etc.
        :param _builtins.bool exclude_metal: In case excludeMetal is set to true, metal types will not be available for scaling.
        :param Sequence[_builtins.str] hypervisors: The filtered instance types will have a hypervisor type from this list. Valid values: `nitro`, `xen`.
        :param Sequence[_builtins.str] include_families: Types belonging to a family from the IncludeFamilies will be available for scaling (asterisk wildcard is also supported). For example, C* will include instance types from these families: c5, c4, c4a, etc.
        :param _builtins.str is_ena_supported: Ena is supported or not.
        :param _builtins.int max_gpu: Maximum total number of GPUs.
        ...
        :param _builtins.int min_network_performance: Minimum Bandwidth in Gib/s of network performance.
        :param _builtins.int min_vcpu: Minimum number of vcpus available.
        :param Sequence[_builtins.str] root_device_types: The filtered instance types will have a root device types from this list. Valid values: `ebs`, or `instance-store`.
        :param Sequence[_builtins.str] virtualization_types: The filtered instance types will support at least one of the virtualization types from this list. Valid values: `hvm`, `paravirtual`.
        """
        if categories is not None:
            pulumi.set(__self__, "categories", categories)
        if disk_types is not None:
...
class OceanLaunchSpecResourceLimit(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int max_instance_count: Set a maximum number of instances per Virtual Node Group. Can be null. If set, value must be greater than or equal to 0.
        :param _builtins.int min_instance_count: Set a minimum number of instances per Virtual Node Group. Can be null. If set, value must be greater than or equal to 0.
        """
...
class OceanLaunchSpecStartupTaint(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str effect: Set startup taint effect.
        :param _builtins.str key: Set startup taint key.
        :param _builtins.str value: Set startup taint value.
        """
...
class OceanLaunchSpecStrategy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 utilize_commitments: Optional[_builtins.bool] = None,
                 utilize_reserved_instances: Optional[_builtins.bool] = None):
        """
        :param _builtins.int draining_timeout: The configurable amount of time that Ocean will wait for the draining process to complete before terminating an instance. If you have not defined a draining timeout, the default of 300 seconds will be used.
        :param 'OceanLaunchSpecStrategyOrientationArgs' orientation: Vng orientation configuration.
        :param _builtins.int spot_percentage: The desired percentage of the Spot instances out of all running instances for this VNG. Only available when the field is not set in the cluster directly (cluster.strategy.spotPercentage).
        :param _builtins.bool utilize_commitments: When set as ‘true’, if savings plans commitments have available capacity, Ocean will utilize them alongside RIs (if exist) to maximize cost efficiency. If the value is set as 'null', it will automatically be inherited from the cluster level.
        :param _builtins.bool utilize_reserved_instances: When set as ‘true’, if reserved instances exist, Ocean will utilize them before launching spot instances. If the value is set as 'null', it will automatically be inherited from the cluster level.
        """
        if draining_timeout is not None:
            pulumi.set(__self__, "draining_timeout", draining_timeout)
    ...
    def utilize_commitments(self) -> Optional[_builtins.bool]:
        """
    ...
    def utilize_reserved_instances(self) -> Optional[_builtins.bool]:
        """
...
class OceanLaunchSpecStrategyOrientation(dict):
    ...
    def __init__(__self__, *,
                 availability_vs_cost: Optional[_builtins.str] = None):
        """
        :param _builtins.str availability_vs_cost: Set this value to control the approach that Ocean takes while launching nodes. Valid values: `"costOriented"`, `"cheapest"`, `"balanced"`.
        """
        if availability_vs_cost is not None:
            pulumi.set(__self__, "availability_vs_cost", availability_vs_cost)
...
class OceanResourceTagSpecification(dict):
    ...
    def __init__(__self__, *,
                 should_tag_volumes: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool should_tag_volumes: Specify if Volume resources will be tagged with Virtual Node Group tags or Ocean tags.
        """
        if should_tag_volumes is not None:
            pulumi.set(__self__, "should_tag_volumes", should_tag_volumes)
...
class OceanScheduledTaskShutdownHours(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool is_enabled: Toggle the shutdown hours task. (Example: `true`).
        """
        pulumi.set(__self__, "time_windows", time_windows)
        if is_enabled is not None:
            pulumi.set(__self__, "is_enabled", is_enabled)
...
class OceanScheduledTaskTask(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str task_type: Valid values: `clusterRoll` `amiAutoUpdate`. Required for `cluster.scheduling.tasks`
...
class OceanScheduledTaskTaskParametersAmiAutoUpdate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 minor_version: Optional[_builtins.bool] = None,
                 patch: Optional[_builtins.bool] = None):
        """
        ...
        :param _builtins.bool apply_roll: When the AMI is updated according to the configuration set, a cluster roll can be triggered
        :param _builtins.bool minor_version: When set to 'true', the auto-update process will update the VNGs’ AMI with the AMI to match the Kubernetes control plane version. either "patch" or "minor_version" must be true.
        :param _builtins.bool patch: When set to 'true', the auto-update process will update the VNGs’ images with the latest security patches. either "patch" or "minorVersion" must be true.
        """
    ...
    def minor_version(self) -> Optional[_builtins.bool]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def patch(self) -> Optional[_builtins.bool]:
        """
...
class OceanUpdatePolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 conditioned_roll_params: Optional[Sequence[_builtins.str]] = None,
        ...
        :param Sequence[_builtins.str] conditioned_roll_params: A custom list of attributes will trigger the cluster roll operation (overrides the predefined list of parameters). Valid only when the `conditioned_roll` parameter is set to true. (Valid values: `"subnet_ids"`,`"whitelist"`,`"blacklist"`,`"user_data"`,`"image_id"`,`"security_groups"`,`"key_name"`,`"iam_instance_profile"`,`"associate_public_ip_address"`,`"load_balancers"`,`"instance_metadata_options"`,`"ebs_optimized"`,`"root_volume_size"`)
    ...
    def conditioned_roll_params(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class SuspensionSuspension(dict):
    def __init__(__self__, *,
                 name: _builtins.str):
        """
        :param _builtins.str name: The name of process to suspend. Valid values: `"AUTO_HEALING" , "OUT_OF_STRATEGY", "PREVENTIVE_REPLACEMENT", "REVERT_PREFERRED", or "SCHEDULING"`.
        """
        pulumi.set(__self__, "name", name)
