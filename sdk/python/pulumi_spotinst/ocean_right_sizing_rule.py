...
class OceanRightSizingRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 attach_workloads: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OceanRightSizingRuleAttachWorkloadArgs']]]]] = None,
                 detach_workloads: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OceanRightSizingRuleDetachWorkloadArgs']]]]] = None,
                 ocean_id: Optional[pulumi.Input[str]] = None,
                 recommendation_application_boundaries: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OceanRightSizingRuleRecommendationApplicationBoundaryArgs']]]]] = None,
                 recommendation_application_intervals: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OceanRightSizingRuleRecommendationApplicationIntervalArgs']]]]] = None,
                 recommendation_application_min_thresholds: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OceanRightSizingRuleRecommendationApplicationMinThresholdArgs']]]]] = None,
                 recommendation_application_overhead_values: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['OceanRightSizingRuleRecommendationApplicationOverheadValueArgs']]]]] = None,
                 restart_pods: Optional[pulumi.Input[bool]] = None,
                 rule_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
