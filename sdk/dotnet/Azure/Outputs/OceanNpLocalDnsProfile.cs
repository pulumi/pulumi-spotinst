...
namespace Pulumi.SpotInst.Azure.Outputs
{
    ...
    [OutputType]
    public sealed class OceanNpLocalDnsProfile
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.OceanNpLocalDnsProfileKubeDnsOverride> KubeDnsOverrides;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.OceanNpLocalDnsProfileVnetDnsOverride> VnetDnsOverrides;

        [OutputConstructor]
        private OceanNpLocalDnsProfile(
            ImmutableArray<Outputs.OceanNpLocalDnsProfileKubeDnsOverride> kubeDnsOverrides,

            string mode,

            ImmutableArray<Outputs.OceanNpLocalDnsProfileVnetDnsOverride> vnetDnsOverrides)
        {
