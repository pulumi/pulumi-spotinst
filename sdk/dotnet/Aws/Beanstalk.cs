...
namespace Pulumi.SpotInst.Aws
{
    ...
    public partial class Beanstalk : Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.BeanstalkScheduledTasks>> ScheduledTasks { get; private set; } = null!;
    ...
    public sealed class BeanstalkArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.BeanstalkScheduledTasksArgs>? _scheduledTasks;
        public InputList<Inputs.BeanstalkScheduledTasksArgs> ScheduledTasks
        {
            get => _scheduledTasks ?? (_scheduledTasks = new InputList<Inputs.BeanstalkScheduledTasksArgs>());
    ...
    public sealed class BeanstalkState : Pulumi.ResourceArgs
    {
        ...
        [Input("scheduledTasks")]
        private InputList<Inputs.BeanstalkScheduledTasksGetArgs>? _scheduledTasks;
        public InputList<Inputs.BeanstalkScheduledTasksGetArgs> ScheduledTasks
        {
            get => _scheduledTasks ?? (_scheduledTasks = new InputList<Inputs.BeanstalkScheduledTasksGetArgs>());
            set => _scheduledTasks = value;
        }
    ...
    public sealed class BeanstalkScheduledTasksArgs : Pulumi.ResourceArgs
    {
        [Input("adjustment")]
        ...
        public BeanstalkScheduledTasksArgs()
        {
        }
    }

    public sealed class BeanstalkScheduledTasksGetArgs : Pulumi.ResourceArgs
    {
        [Input("adjustment")]
        public Input<string>? Adjustment { get; set; }
        ...
        public BeanstalkScheduledTasksGetArgs()
        {
        }
    }
    }
    ...
    [OutputType]
    public sealed class BeanstalkScheduledTasks
    {
        ...
        [OutputConstructor]
        private BeanstalkScheduledTasks(
            string? adjustment,
