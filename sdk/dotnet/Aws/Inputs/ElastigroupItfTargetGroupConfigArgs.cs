...
namespace Pulumi.SpotInst.Aws.Inputs
{
    ...
    public sealed class ElastigroupItfTargetGroupConfigArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("matchers")]
        private InputList<Inputs.ElastigroupItfTargetGroupConfigMatcherArgs>? _matchers;
        public InputList<Inputs.ElastigroupItfTargetGroupConfigMatcherArgs> Matchers
        {
            get => _matchers ?? (_matchers = new InputList<Inputs.ElastigroupItfTargetGroupConfigMatcherArgs>());
            set => _matchers = value;
        }
        ...
        [Input("tags")]
        private InputList<Inputs.ElastigroupItfTargetGroupConfigTagArgs>? _tags;

        /// <summary>
        /// A key/value mapping of tags to assign to the resource.
        /// </summary>
        public InputList<Inputs.ElastigroupItfTargetGroupConfigTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.ElastigroupItfTargetGroupConfigTagArgs>());
            set => _tags = value;
        }
