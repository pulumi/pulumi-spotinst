...
namespace Pulumi.SpotInst.Aws
{
    ...
    public partial class Account : global::Pulumi.CustomResource
    {
        ...
        public Account(string name, AccountArgs? args = null, CustomResourceOptions? options = null)
            : base("spotinst:aws/account:Account", name, args ?? new AccountArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Account(string name, Input<string> id, AccountState? state = null, CustomResourceOptions? options = null)
            : base("spotinst:aws/account:Account", name, state, MakeResourceOptions(options, id))
        {
        }
