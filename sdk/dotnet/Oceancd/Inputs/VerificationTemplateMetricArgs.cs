...
namespace Pulumi.SpotInst.Oceancd.Inputs
{
    ...
    public sealed class VerificationTemplateMetricArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("baseline")]
        public Input<Inputs.VerificationTemplateMetricBaselineArgs>? Baseline { get; set; }
        ...
        private InputList<Inputs.VerificationTemplateMetricProviderArgs>? _providers;

        /// <summary>
        /// The name of the monitoring tool chosen for the metric.
        /// </summary>
        public InputList<Inputs.VerificationTemplateMetricProviderArgs> Providers
        {
            get => _providers ?? (_providers = new InputList<Inputs.VerificationTemplateMetricProviderArgs>());
