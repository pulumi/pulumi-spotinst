...
func NewPolicy(ctx *pulumi.Context,
	...
	if args.PolicyContents == nil {
		return nil, errors.New("invalid value for required argument 'PolicyContents'")
	}
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Policy
	err := ctx.RegisterResource("spotinst:organization/policy:Policy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicy(ctx *pulumi.Context,
	...
	var resource Policy
	err := ctx.ReadResource("spotinst:organization/policy:Policy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type policyState struct {
	...
	// Set permissions objects list.
	PolicyContents []PolicyPolicyContent `pulumi:"policyContents"`
}
...
func (o PolicyOutput) PolicyContents() PolicyPolicyContentArrayOutput {
	return o.ApplyT(func(v *Policy) PolicyPolicyContentArrayOutput { return v.PolicyContents }).(PolicyPolicyContentArrayOutput)
}
