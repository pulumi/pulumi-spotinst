...
.make/install_plugins: .pulumi/bin/pulumi
	...
	.pulumi/bin/pulumi plugin install resource aws 4.1.0
	.pulumi/bin/pulumi plugin install resource azure 4.1.0
	.pulumi/bin/pulumi plugin install resource random 4.0.0
	@touch $@
